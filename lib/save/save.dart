...
//109
  graph.addEdge("경영관 계단 아래", "경영관 계단 위", 74, "계단위", "도보",
      node2X: 2148,
      node2Y: 3124,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 계단 위", "경영관 계단 아래", 39, "계단아래", "도보");
//110
...
//118
  graph.addEdge("혜화관 사회과학관 갈림길", "사회과학관 쪽문 앞 계단 아래", 40, "계단아래", "도보",
      node2X: 2258,
      node2Y: 2785,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("혜화관 사회과학관 갈림길", "사회과학관 쪽문 앞 계단 아래", 76, "계단위", "도보");
//119 생략
//120
...
//만해관 입구
  graph.addEdge("만해관 입구", "만해관[법학관]", 100000, "평지", "도보",
      node2X: 1672,
      node2Y: 2801,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("만해관[법학관]", "만해관 입구", 100000, "평지", "도보");
//만해관 옆입구
  graph.addEdge("만해관 옆입구", "만해관[법학관]", 100000, "평지", "도보");
  graph.addEdge("만해관[법학관]", "만해관 옆입구", 100000, "평지", "도보");
//만해관 2층 입구
  graph.addEdge("만해관 2층 입구", "만해관[법학관]", 100000, "평지", "도보");
  graph.addEdge("만해관[법학관]", "만해관 2층 입구", 100000, "평지", "도보");
//법학관 1층 입구
  graph.addEdge("법학관 1층 입구", "만해관[법학관]", 100000, "평지", "도보");
  graph.addEdge("만해관[법학관]", "법학관 1층 입구", 100000, "평지", "도보");
  ...
  //학림관(입구: 편의점 입구, 입구, 우측 앞문, 오른쪽 뒷문, 뒷문, 왼쪽 뒷문, 좌측 앞문) --> 아직 안함
  //        학림관
//편의점 입구
  graph.addEdge("학림관 편의점 입구", "학림관", 100, "평지", "도보",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("학림관", "학림관 편의점 입구", 100, "평지", "도보");
//입구
  graph.addEdge("학림관 입구", "학림관", 100, "평지", "도보");
  graph.addEdge("학림관", "학림관 입구", 100, "평지", "도보");
//우측 앞문
  graph.addEdge("학림관 우측 앞문", "학림관", 100, "평지", "도보");
  graph.addEdge("학림관", "학림관 우측 앞문", 100, "평지", "도보");
//오른쪽 뒷문
  graph.addEdge("학림관 오른쪽 뒷문", "학림관", 100, "평지", "도보");
  graph.addEdge("학림관", "학림관 오른쪽 뒷문", 100, "평지", "도보");
//뒷문
  graph.addEdge("학림관 뒷문", "학림관", 100, "평지", "도보");
  graph.addEdge("학림관", "학림관 뒷문", 100, "평지", "도보");
//왼쪽 뒷문
...
//      사회과학관
//사회과학관 입구
  graph.addEdge("사회과학관 입구", "사회과학관", 100, "평지", "도보",
      node2X: 2277,
      node2Y: 2919,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("사회과학관", "사회과학관 입구", 100, "평지", "도보");
//사회과학관 쪽문
  graph.addEdge("사회과학관 쪽문", "사회과학관", 100, "평지", "도보");
  graph.addEdge("사회과학관", "사회과학관 쪽문", 100, "평지", "도보");
//사회과학관 엘베 입구
  graph.addEdge("사회과학관 엘베 입구", "사회과학관", 100, "평지", "도보");
  graph.addEdge("사회과학관", "사회과학관 엘베 입구", 100, "평지", "도보");
//      경영관
//사회과학관-경영관
  graph.addEdge("사회과학관", "경영관", 100, "평지", "도보",
      node2X: 2368,
      node2Y: 3212,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관", "사회과학관", 100, "평지", "도보");
//경영관 쪽문
  graph.addEdge("경영관 쪽문", "경영관", 100, "평지", "도보");
  graph.addEdge("경영관", "경영관 쪽문", 100, "평지", "도보");
//사회과학관 옆문
  graph.addEdge("사회과학관 옆문", "경영관", 100, "평지", "도보");
  graph.addEdge("경영관", "사회과학관 옆문", 100, "평지", "도보");
//경영관 입구
  graph.addEdge("경영관 입구", "경영관", 100, "평지", "도보");
  graph.addEdge("경영관", "경영관 입구", 100, "평지", "도보");
//      문화관
//문화관 쪽문
...
//과학관 좌측 입구
  graph.addEdge("과학관 좌측 입구", "과학관", 100, "평지", "도보",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("과학관", "과학관 좌측 입구", 100, "평지", "도보");
//과학관 정문
  graph.addEdge("과학관 정문", "과학관", 100, "평지", "도보");
  graph.addEdge("과학관", "과학관 정문", 100, "평지", "도보");
//과학관 우측 입구
