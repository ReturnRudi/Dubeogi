...
//333
  ...
  //737
  graph.addEdge("체육관 쪽 입구6", "체육관 쪽 입구5", 14, 0.45, "계단아래", "도보",
      node2X: 1312,
      node2Y: 2086,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("체육관 쪽 입구5", "체육관 쪽 입구6", 10, 1.5, "계단위", "도보");
  //738
  graph.addEdge("체육관 쪽 입구5", "체육관 쪽 입구4", 1.90476, 0.12, "계단아래", "도보",
      node2X: 1321,
      node2Y: 2097,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("체육관 쪽 입구4", "체육관 쪽 입구5", 2.66667, 0.4, "계단위", "도보");
  //739
