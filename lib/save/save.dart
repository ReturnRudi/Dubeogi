...
//69
  graph.addEdge("팔정도 좌측 하단3", "명진관 왼쪽 계단 위", 15.576, 1.0384, "오르막", "도보");
...
//75
  graph.addEdge("명진관 오른쪽 계단 위", "명진관 오른쪽 계단 아래", 15.2736, 1.01824, "내리막", "도보",
      ...
      building2: "실외",
      showRoute2: true);
  graph.addEdge("명진관 오른쪽 계단 아래", "명진관 오른쪽 계단 위", 15.2736, 1.01824, "오르막", "도보");
//76
...
//118 계단 개수 확인 후 수정
  ...
  //735 계단 개수 확인 후 수정
  graph.addEdge("사회과학관 2층 쪽문 앞 계단 위", "사회과학관 2층 쪽문 앞 계단 아래", 3.80952, 0.24, "계단아래", "도보",
      node2X: 2274,
      node2Y: 2790,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("사회과학관 2층 쪽문 앞 계단 아래", "사회과학관 2층 쪽문 앞 계단 위", 5.33333, 0.8, "계단위", "도보");
//119 생략
//120
...
//122 계단 개수 확인 후 수정
  graph.addEdge("문화관 사회과학관 계단 위", "문화관 사회과학관 계단 중간1", 8.57143, 0.54, "계단아래", "도보",
      node2X: 2326,
      node2Y: 2757,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("문화관 사회과학관 계단 중간1", "문화관 사회과학관 계단 위", 12, 1.8, "계단위", "도보");
//123 계단 개수 확인 후 수정
