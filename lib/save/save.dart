...
//5
  graph.addEdge("중도 옆 계단 아래", "중도 옆 계단 위", 9.70139, 0.64676, "계단위", "도보",
      node2X: 1139,
      node2Y: 2712,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("중도 옆 계단 위", "중도 옆 계단 아래", 9.70139, 0.64676, "계단아래", "도보");
//6
...
//10
  graph.addEdge("중도 옆옆 계단 위", "중도 옆옆 계단 아래", 2.16744, 0.144496, "계단아래", "도보",
      node2X: 1047,
      node2Y: 2665,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("중도 옆옆 계단 아래", "중도 옆옆 계단 위", 2.16744, 0.144496, "계단위", "도보");
//11
...
//19
  graph.addEdge("상록원 가는 길 명진관 계단 아래", "상록원 가는 길 명진관 계단 중간", 2.33881, 0.155921, "계단위", "도보",
      node2X: 1162,
      node2Y: 2960,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("상록원 가는 길 명진관 계단 중간", "상록원 가는 길 명진관 계단 아래", 2.33881, 0.155921, "계단아래", "도보");
//20
  graph.addEdge("상록원 가는 길 명진관 계단 중간", "상록원 가는 길 명진관 계단 위", 2.66666, 0.177777, "계단위", "도보",
      node2X: 1173,
      node2Y: 2950,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("상록원 가는 길 명진관 계단 위", "상록원 가는 길 명진관 계단 중간", 2.66666, 0.177777, "계단아래", "도보");
//21
...
//22
  graph.addEdge("상록원 가는 길", "상록원 가는 길2", 19.3737, 1.29158, "오르막", "차도",
      node2X: 1102,
      node2Y: 3089,
      isInside2: 0,
      building2: "실외",
...
//35
  graph.addEdge("대운동장 상록원 계단 위", "대운동장 상록원 계단 갈림길", 25.992, 1.7328, "계단아래", "도보",
      node2X: 1423,
      node2Y: 3193,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("대운동장 상록원 계단 갈림길", "대운동장 상록원 계단 위", 25.992, 1.7328, "계단위", "도보");
//36
  graph.addEdge("대운동장 상록원 계단 갈림길", "대운동장 상록원 계단 아래", 9.93085, 0.662057, "계단아래", "도보",
      node2X: 1475,
      node2Y: 3212,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("대운동장 상록원 계단 아래", "대운동장 상록원 계단 갈림길", 9.93085, 0.662057, "계단위", "도보");
//37
  graph.addEdge("대운동장 상록원 계단 갈림길", "과학관 우측 입구 앞", 12.9377, 0.862512, "계단위", "도보",
      node2X: 1444,
      node2Y: 3124,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("과학관 우측 입구 앞", "대운동장 상록원 계단 갈림길", 12.9377, 0.862512, "계단아래", "도보");
//38
...
//69
  graph.addEdge("팔정도 좌측 하단3", "명진관 왼쪽 계단 위", 15.576, 1.0384, "계단위", "도보");
  graph.addEdge("명진관 왼쪽 계단 위", "팔정도 좌측 하단3", 15.576, 1.0384, "계단아래", "도보");
//70
...
//74
  graph.addEdge("명진관 정문 앞", "명진관 중앙 계단 아래", 11.3591, 0.757272, "계단아래", "도보",
      node2X: 1351,
      node2Y: 2792,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("명진관 중앙 계단 아래", "명진관 정문 앞", 11.3591, 0.757272, "계단위", "도보");
//75
  graph.addEdge("명진관 오른쪽 계단 위", "명진관 오른쪽 계단 아래", 15.2736, 1.01824, "계단아래", "도보",
      node2X: 1522,
      node2Y: 2847,
      isInside2: 0,
      building2: "실외",
      showRoute2: true);
  graph.addEdge("명진관 오른쪽 계단 아래", "명진관 오른쪽 계단 위", 15.2736, 1.01824, "계단위", "도보");
//76
...
//79
  graph.addEdge("과학관 차도 입구", "만해관 내려가는 길1", 26.1678, 1.74452, "내리막", "차도",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("만해관 내려가는 길1", "과학관 차도 입구", 26.1678, 1.74452, "오르막", "차도");
//80
...
//81
  graph.addEdge("만해관 내려가는 길2", "만해관 내려가는 길3", 16.3008, 1.08672, "평지", "차도",
      node2X: 1556,
      node2Y: 3200,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("만해관 내려가는 길3", "만해관 내려가는 길2", 16.3008, 1.08672, "평지", "차도");
//82
...
//84
  graph.addEdge("만해관 내려가는 길3", "정문3", 25.8237, 1.72158, "내리막", "차도",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("정문3", "만해관 내려가는 길3", 25.8237, 1.72158, "오르막", "차도");
//85
  graph.addEdge("정문3", "정문2", 73.5026, 4.90018, "내리막", "차도",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("정문2", "정문3", 73.5026, 4.90018, "오르막", "차도");
//86
  graph.addEdge("정문2", "정문", 52.8705, 3.5247, "내리막", "차도",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("정문", "정문2", 52.8705, 3.5247, "오르막", "차도");
//87
  graph.addEdge("만해관 내려가는 길1", "만해관 옆 계단 아래", 10.5239, 0.701593, "계단아래", "도보",
      node2X: 1557,
      node2Y: 3089,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("만해관 옆 계단 아래", "만해관 내려가는 길1", 10.5239, 0.701593, "계단위", "도보");
//88
...
//109
  graph.addEdge("경영관 계단 아래", "경영관 계단 위", 13.1094, 0.873959, "계단위", "도보",
      node2X: 2148,
      node2Y: 3124,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 계단 위", "경영관 계단 아래", 13.1094, 0.873959, "계단아래", "도보");
//110
...
//118
  graph.addEdge("혜화관 사회과학관 갈림길", "사회과학관 2층 쪽문 앞 계단 아래", 9.07061, 0.604707, "계단아래", "도보",
      node2X: 2258,
      node2Y: 2785,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("사회과학관 2층 쪽문 앞 계단 아래", "혜화관 사회과학관 갈림길", 9.07061, 0.604707, "계단위", "도보");
//119 생략
//120
  graph.addEdge("사회과학관 2층 쪽문 앞 계단 아래", "사회과학관 2층 쪽문", 7.63151, 0.508767, "평지", "도보",
      node2X: 2297,
      node2Y: 2802,
      isInside2: 0,
      building2: "실외",
      showRoute2: true);
  graph.addEdge("사회과학관 2층 쪽문", "사회과학관 2층 쪽문 앞 계단 아래", 7.63151, 0.508767, "평지", "도보");
//121
...
//122
  graph.addEdge("문화관 사회과학관 계단 위", "문화관 사회과학관 계단 중간1", 6.36984, 0.424656, "계단아래", "도보",
      node2X: 2326,
      node2Y: 2757,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("문화관 사회과학관 계단 중간1", "문화관 사회과학관 계단 위", 6.36984, 0.424656, "계단위", "도보");
//123
  graph.addEdge("문화관 사회과학관 계단 중간1", "문화관 사회과학관 계단 중간2", 5.96283, 0.397522, "계단아래", "도보",
      node2X: 2338,
      node2Y: 2788,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("문화관 사회과학관 계단 중간2", "문화관 사회과학관 계단 중간1", 5.96283, 0.397522, "계단위", "도보");
//124
  graph.addEdge("문화관 사회과학관 계단 중간2", "문화관 사회과학관 계단 아래", 16.4911, 1.09941, "계단아래", "도보",
      node2X: 2404,
      node2Y: 2724,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("문화관 사회과학관 계단 아래", "문화관 사회과학관 계단 중간2", 16.4911, 1.09941, "계단위", "도보");
//125
...
//129
  ...
  //422
  graph.addEdge("경영관 뒷계단 아래", "경영관 2층 뒷문", 3.80097, 0.253398, "계단위", "도보",
      node2X: 2409,
      node2Y: 3137,
      isInside2: 0,
      building2: "실외",
      showRoute2: true);
  graph.addEdge("경영관 2층 뒷문", "경영관 뒷계단 아래", 3.80097, 0.253398, "계단아래", "도보");
//130
...
//131
  graph.addEdge("동대입구 문화관2", "동대입구 문화관1", 27.2662, 1.81774, "평지", "차도",
      node2X: 2517,
      node2Y: 2537,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("동대입구 문화관1", "동대입구 문화관2", 27.2662, 1.81774, "평지", "차도");
//132
...
//135
  ...
  //136
  graph.addEdge("가든쿡 입구 앞", "가든쿡 입구", 10.3807, 0.69205, "계단아래", "도보",
      node2X: 2529,
      node2Y: 2741,
      isInside2: 0,
      building2: "실외",
      showRoute2: true);
  graph.addEdge("가든쿡 입구", "가든쿡 입구 앞", 10.3807, 0.69205, "계단위", "도보");
//139
...
//144
  graph.addEdge("혜화관 사회과학관 갈림길", "혜화관 팔정도 계단 아래", 37.1643, 2.47762, "오르막", "차도",
      node2X: 2017,
      node2Y: 2694,
      isInside2: 0,
      building2: "실외",
...
//145
  graph.addEdge("혜화관 팔정도 계단 아래", "혜화관 팔정도 계단 위", 26.0847, 1.73898, "오르막", "도보",
      node2X: 1872,
      node2Y: 2705,
      isInside2: 0,
      building2: "실외",
      showRoute2: true);
  graph.addEdge("혜화관 팔정도 계단 위", "혜화관 팔정도 계단 아래", 26.0847, 1.73898, "내리막", "도보");
//146
  graph.addEdge("혜화관 팔정도 계단 위", "법학관 뒷길1", 10.5894, 0.705962, "평지", "차도",
      node2X: 1870,
      node2Y: 2764,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("법학관 뒷길1", "혜화관 팔정도 계단 위", 10.5894, 0.705962, "평지", "차도");
//147
  graph.addEdge("법학관 뒷길1", "법학관 뒷길2", 13.0959, 0.873059, "평지", "차도",
      node2X: 1827,
      node2Y: 2823,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("법학관 뒷길2", "법학관 뒷길1", 13.0959, 0.873059, "평지", "차도");
//148
...
//152
  graph.addEdge("만해관 2층 입구 앞", "만해관 2층 입구", 2.66666, 0.177777, "계단위", "도보",
      node2X: 1701,
      node2Y: 2874,
      isInside2: 0,
      building2: "실외",
      showRoute2: true);
  graph.addEdge("만해관 2층 입구", "만해관 2층 입구 앞", 2.66666, 0.177777, "계단아래", "도보");
//153
...
//155
  graph.addEdge("정각원 입구 앞", "정각원 입구", 3.69799, 0.246533, "계단위", "도보",
      node2X: 1742,
      node2Y: 3052,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("정각원 입구", "정각원 입구 앞", 3.69799, 0.246533, "계단아래", "도보");
//156
  graph.addEdge("정각원 입구 앞", "정각원 계단 아래", 9.14128, 0.609419, "계단아래", "도보");
  graph.addEdge("정각원 계단 아래", "정각원 입구 앞", 9.14128, 0.609419, "계단위", "도보");
//157
...
//169
  graph.addEdge("팔정도 혜화관1", "팔정도 혜화관2", 23.4842, 1.56562, "내리막", "차도",
      node2X: 1729,
      node2Y: 2589,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("팔정도 혜화관2", "팔정도 혜화관1", 23.4842, 1.56562, "오르막", "차도");
//170
...
//207
  graph.addEdge("팔정도 본관 계단 위", "다향관 2층 입구 앞", 4.89609, 0.326406, "내리막", "차도",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("다향관 2층 입구 앞", "팔정도 본관 계단 위", 4.89609, 0.326406, "오르막", "차도");
//208
...
//209
  graph.addEdge("다향관 2층 입구 앞", "다향관 1층 입구 앞", 7.55311, 0.50354, "내리막", "차도",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("다향관 1층 입구 앞", "다향관 2층 입구 앞", 7.55311, 0.50354, "오르막", "차도");
//210
  ...
  graph.addEdge("다향관 1층 입구 앞2", "다향관 1층 입구 앞3", 3.42703, 0.228469, "내리막", "도보",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("다향관 1층 입구 앞3", "다향관 1층 입구 앞2", 3.42703, 0.228469, "오르막", "도보");
  //629
...
//212
  graph.addEdge("다향관 1층 입구 앞", "팔정도 후문 차도1", 17.8552, 1.19035, "내리막", "차도",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("팔정도 후문 차도1", "다향관 1층 입구 앞", 17.8552, 1.19035, "오르막", "차도");
//213
...
//321
  graph.addEdge("108계단 중간1", "신공 7층 방향 갈림길", 37, 37, "평지", "도보",
      node2X: 898,
      node2Y: 2584,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("신공 7층 방향 갈림길", "108계단 중간1", 37, 37, "평지", "도보");
  //322
  graph.addEdge("신공 7층 방향 갈림길", "신공 7층 경계", 32.573, 32.573, "평지", "도보",
      node2X: 896,
      node2Y: 2593,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("신공 7층 경계", "신공 7층 방향 갈림길", 32.573, 32.573, "평지", "도보");
//323
  graph.addEdge("신공 7층 방향 갈림길", "108계단 중간2", 51.5461, 51.5461, "평지", "도보",
      node2X: 947,
      node2Y: 2600,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("108계단 중간2", "신공 7층 방향 갈림길", 51.5461, 51.5461, "평지", "도보");
//324
...
//333
  ...
  //334
  graph.addEdge("충무로쪽 입구", "남산학사 계단 앞", 20, 20, "평지", "도보",
      node2X: 586,
      node2Y: 2568,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("남산학사 계단 앞", "충무로쪽 입구", 20, 20, "평지", "도보");
  ...
  //733
  graph.addEdge("남산학사 계단 앞", "남산학사 계단 위", 10.6301, 10.6301, "평지", "도보",
      node2X: 593,
      node2Y: 2576,
      isInside2: 1,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("남산학사 계단 위", "남산학사 계단 앞", 10.6301, 10.6301, "평지", "도보");
//335
...
//348
  ...
  //703
  graph.addEdge("신공 7층 경계", "신공 7층 경계 안", 23.4094, 23.4094, "평지", "도보",
      node2X: 888,
      node2Y: 2615,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 경계 안", "신공 7층 경계", 23.4094, 23.4094, "평지", "도보");
  //676
  graph.addEdge("신공 7층 경계 안", "신공 7층 입구 앞", 15.5242, 15.5242, "평지", "도보",
      node2X: 873,
      node2Y: 2611,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 입구 앞", "신공 7층 경계 안", 15.5242, 15.5242, "평지", "도보");
  //677
  graph.addEdge("신공 7층 입구 앞", "신공 7층 입구 계단 가는길1", 95.1893, 95.1893, "평지", "도보",
      node2X: 783,
      node2Y: 2580,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 입구 계단 가는길1", "신공 7층 입구 앞", 95.1893, 95.1893, "평지", "도보");
  //678
  graph.addEdge("신공 7층 입구 계단 가는길1", "신공 7층 입구 계단 가는길2", 28.2312, 28.2312, "평지", "도보",
      node2X: 772,
      node2Y: 2606,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 입구 계단 가는길2", "신공 7층 입구 계단 가는길1", 28.2312, 28.2312, "평지", "도보");
  //679
  graph.addEdge("신공 7층 입구 계단 가는길2", "신공 7층 입구 계단 앞", 24.3516, 24.3516, "평지", "도보",
      node2X: 749,
      node2Y: 2598,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 입구 계단 앞", "신공 7층 입구 계단 가는길2", 24.3516, 24.3516, "평지", "도보");
  //680
  graph.addEdge("신공 7층 입구 계단 앞", "신공 7층 입구 계단 문", 12.6491, 12.6491, "평지", "도보",
      node2X: 753,
      node2Y: 2586,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 입구 계단 문", "신공 7층 입구 계단 앞", 12.6491, 12.6491, "평지", "도보");
  //702
  graph.addEdge("신공 7층 입구 계단 문", "신공 7층 입구 계단", 5.09902, 5.09902, "평지", "도보");
  graph.addEdge("신공 7층 입구 계단", "신공 7층 입구 계단 문", 5.09902, 5.09902, "평지", "도보");
  //704
  graph.addEdge("신공 7층 입구 앞", "신공 7층 입구", 9.21954, 9.21954, "평지", "도보",
      node2X: 871,
      node2Y: 2620,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: true);
  graph.addEdge("신공 7층 입구", "신공 7층 입구 앞", 9.21954, 9.21954, "평지", "도보");
  //681
  graph.addEdge("신공 7층 입구", "신공 7층 전층 엘베 앞", 26.5707, 26.5707, "평지", "도보",
      node2X: 862,
      node2Y: 2645,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 전층 엘베 앞", "신공 7층 입구", 26.5707, 26.5707, "평지", "도보");
  //682
  graph.addEdge("신공 7층 입구", "신공 7층 왼쪽 위", 37.5766, 37.5766, "평지", "도보",
      node2X: 837,
      node2Y: 2636,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 왼쪽 위", "신공 7층 입구", 37.5766, 37.5766, "평지", "도보");
  //683
  graph.addEdge("신공 7층 왼쪽 위", "신공 7층 전층 엘베 앞", 26.5707, 26.5707, "평지", "도보");
  graph.addEdge("신공 7층 전층 엘베 앞", "신공 7층 왼쪽 위", 26.5707, 26.5707, "평지", "도보");
  //684
  graph.addEdge("신공 7층 전층 엘베 앞", "신공 7층 전층 엘베", 5.09902, 5.09902, "평지", "도보");
  graph.addEdge("신공 7층 전층 엘베", "신공 7층 전층 엘베 앞", 5.09902, 5.09902, "평지", "도보");
  //705
  graph.addEdge("신공 7층 전층 엘베 앞", "신공 7층 오른쪽 위", 11.7047, 11.7047, "평지", "도보",
      node2X: 873,
      node2Y: 2649,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 오른쪽 위", "신공 7층 전층 엘베 앞", 11.7047, 11.7047, "평지", "도보");
  //685
  graph.addEdge("신공 7층 오른쪽 위", "신공 7층 화장실 오른쪽", 94.2444, 94.2444, "평지", "도보",
      node2X: 842,
      node2Y: 2738,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 화장실 오른쪽", "신공 7층 오른쪽 위", 94.2444, 94.2444, "평지", "도보");
  //686
  graph.addEdge("신공 7층 화장실 오른쪽", "신공 7층 화장실 왼쪽", 39.9249, 39.9249, "평지", "도보",
      node2X: 805,
      node2Y: 2723,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 화장실 왼쪽", "신공 7층 화장실 오른쪽", 39.9249, 39.9249, "평지", "도보");
  //692
  graph.addEdge("신공 7층 화장실 왼쪽", "신공 7층 왼쪽 위", 92.6984, 92.6984, "평지", "도보",
      node2X: 805,
      node2Y: 2723,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 왼쪽 위", "신공 7층 화장실 왼쪽", 92.6984, 92.6984, "평지", "도보");
  //687
  graph.addEdge("신공 7층 화장실 오른쪽", "신공 7층 뒤편1", 49.6488, 49.6488, "평지", "도보",
      node2X: 826,
      node2Y: 2785,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 뒤편1", "신공 7층 화장실 오른쪽", 49.6488, 49.6488, "평지", "도보");
  //688
  graph.addEdge("신공 7층 뒤편1", "신공 7층 뒤편2", 43.2666, 43.2666, "평지", "도보",
      node2X: 790,
      node2Y: 2809,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 뒤편2", "신공 7층 뒤편1", 43.2666, 43.2666, "평지", "도보");
  //689
  graph.addEdge("신공 7층 뒤편2", "신공 7층 뒤편3", 15.8114, 15.8114, "평지", "도보",
      node2X: 775,
      node2Y: 2804,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 뒤편3", "신공 7층 뒤편2", 15.8114, 15.8114, "평지", "도보");
  //690
  graph.addEdge("신공 7층 뒤편3", "신공 7층 뒤편4", 38.8973, 38.8973, "평지", "도보",
      node2X: 787,
      node2Y: 2767,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 뒤편4", "신공 7층 뒤편3", 38.8973, 38.8973, "평지", "도보");
  //691
  graph.addEdge("신공 7층 뒤편4", "신공 7층 화장실 왼쪽", 47.5395, 47.5395, "평지", "도보");
  graph.addEdge("신공 7층 화장실 왼쪽", "신공 7층 뒤편4", 47.5395, 47.5395, "평지", "도보");
  //693
  graph.addEdge("신공 7층 뒤편4", "신공 7층 뒤편5", 69.8928, 69.8928, "평지", "도보",
      node2X: 721,
      node2Y: 2744,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 뒤편5", "신공 7층 뒤편4", 69.8928, 69.8928, "평지", "도보");
  //694
  graph.addEdge("신공 7층 뒤편5", "신공 7층 뒤편6", 23.7697, 23.7697, "평지", "도보",
      node2X: 712,
      node2Y: 2766,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 뒤편6", "신공 7층 뒤편5", 23.7697, 23.7697, "평지", "도보");
  //695
  graph.addEdge("신공 7층 뒤편3", "신공 7층 뒤편7", 70.5762, 70.5762, "평지", "도보",
      node2X: 709,
      node2Y: 2779,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 뒤편7", "신공 7층 뒤편3", 70.5762, 70.5762, "평지", "도보");
  //696
  graph.addEdge("신공 7층 뒤편7", "신공 7층 뒤편8", 12.6491, 12.6491, "평지", "도보",
      node2X: 697,
      node2Y: 2775,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 뒤편8", "신공 7층 뒤편7", 12.6491, 12.6491, "평지", "도보");
  //697
  graph.addEdge("신공 7층 뒤편7", "신공 7층 뒤편6", 13.3417, 13.3417, "평지", "도보");
  graph.addEdge("신공 7층 뒤편6", "신공 7층 뒤편7", 13.3417, 13.3417, "평지", "도보");
  //698
  graph.addEdge("신공 7층 뒤편8", "신공 7층 뒷엘베 앞", 13.6015, 13.6015, "평지", "도보",
      node2X: 701,
      node2Y: 2762,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 뒷엘베 앞", "신공 7층 뒤편8", 13.6015, 13.6015, "평지", "도보");
  //699
  graph.addEdge("신공 7층 뒷엘베 앞", "신공 7층 뒤편6", 11.7047, 11.7047, "평지", "도보",
      node2X: 701,
      node2Y: 2762,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 뒤편6", "신공 7층 뒷엘베 앞", 11.7047, 11.7047, "평지", "도보");
  //700
  graph.addEdge("신공 7층 뒷엘베 앞", "신공 7층 뒷엘베", 5.38516, 5.38516, "평지", "도보");
  graph.addEdge("신공 7층 뒷엘베", "신공 7층 뒷엘베 앞", 5.38516, 5.38516, "평지", "도보");
  //701
  graph.addEdge("신공 7층 뒷엘베 앞", "신공 7층 뒷계단", 6.08276, 6.08276, "평지", "도보");
  graph.addEdge("신공 7층 뒷계단", "신공 7층 뒷엘베 앞", 6.08276, 6.08276, "평지", "도보");
  //706
  graph.addEdge("신공 9층 입구", "신공 9층 입구 안", 20.3961, 20.3961, "평지", "도보",
      node2X: 885,
      node2Y: 2617,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 입구 안", "신공 9층 입구", 20.3961, 20.3961, "평지", "도보");
  //707
  graph.addEdge("신공 9층 입구 안", "신공 9층 오른쪽 위", 34.176, 34.176, "평지", "도보",
      node2X: 873,
      node2Y: 2649,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 오른쪽 위", "신공 9층 입구 안", 34.176, 34.176, "평지", "도보");
  //708
  graph.addEdge("신공 9층 입구 안", "신공 9층 전층 엘베 앞", 35.609, 35.609, "평지", "도보",
      node2X: 863,
      node2Y: 2645,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 전층 엘베 앞", "신공 9층 입구 안", 35.609, 35.609, "평지", "도보");
  //709
  graph.addEdge("신공 9층 입구 안", "신공 9층 9층 엘베 앞", 43.2666, 43.2666, "평지", "도보",
      node2X: 849,
      node2Y: 2641,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 9층 엘베 앞", "신공 9층 입구 안", 43.2666, 43.2666, "평지", "도보");
  //710
  graph.addEdge("신공 9층 입구 안", "신공 9층 왼쪽 위", 51.6236, 51.6236, "평지", "도보",
      node2X: 837,
      node2Y: 2636,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 왼쪽 위", "신공 9층 입구 안", 51.6236, 51.6236, "평지", "도보");
  //711
  graph.addEdge("신공 9층 왼쪽 위", "신공 9층 9층 엘베 앞", 13, 13, "평지", "도보");
  graph.addEdge("신공 9층 9층 엘베 앞", "신공 9층 왼쪽 위", 13, 13, "평지", "도보");
  //712
  graph.addEdge("신공 9층 9층 엘베 앞", "신공 9층 9층 엘베", 4.47214, 4.47214, "평지", "도보");
  graph.addEdge("신공 9층 9층 엘베", "신공 9층 9층 엘베 앞", 4.47214, 4.47214, "평지", "도보");
  //713
  graph.addEdge("신공 9층 9층 엘베 앞", "신공 9층 전층 엘베 앞", 14.5602, 14.5602, "평지", "도보");
  graph.addEdge("신공 9층 전층 엘베 앞", "신공 9층 9층 엘베 앞", 14.5602, 14.5602, "평지", "도보");
  //714
  graph.addEdge("신공 9층 전층 엘베 앞", "신공 9층 전층 엘베", 5.38516, 5.38516, "평지", "도보");
  graph.addEdge("신공 9층 전층 엘베", "신공 9층 전층 엘베 앞", 5.38516, 5.38516, "평지", "도보");
  //715
  graph.addEdge("신공 9층 전층 엘베 앞", "신공 9층 오른쪽 위", 10.7703, 10.7703, "평지", "도보",
      node2X: 873,
      node2Y: 2649,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 오른쪽 위", "신공 9층 전층 엘베 앞", 10.7703, 10.7703, "평지", "도보");
  //716
  graph.addEdge("신공 9층 오른쪽 위", "신공 9층 화장실 오른쪽", 94.2444, 94.2444, "평지", "도보",
      node2X: 842,
      node2Y: 2738,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 화장실 오른쪽", "신공 9층 오른쪽 위", 94.2444, 94.2444, "평지", "도보");
  //717
  graph.addEdge("신공 9층 화장실 오른쪽", "신공 9층 화장실 왼쪽", 39.9249, 39.9249, "평지", "도보",
      node2X: 805,
      node2Y: 2723,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 화장실 왼쪽", "신공 9층 화장실 오른쪽", 39.9249, 39.9249, "평지", "도보");
  //723
  graph.addEdge("신공 9층 화장실 왼쪽", "신공 9층 왼쪽 위", 92.6984, 92.6984, "평지", "도보",
      node2X: 805,
      node2Y: 2723,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 왼쪽 위", "신공 9층 화장실 왼쪽", 92.6984, 92.6984, "평지", "도보");
  //718
  graph.addEdge("신공 9층 화장실 오른쪽", "신공 9층 뒤편1", 49.6488, 49.6488, "평지", "도보",
      node2X: 826,
      node2Y: 2785,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 뒤편1", "신공 9층 화장실 오른쪽", 49.6488, 49.6488, "평지", "도보");
  //719
  graph.addEdge("신공 9층 뒤편1", "신공 9층 뒤편2", 43.2666, 43.2666, "평지", "도보",
      node2X: 790,
      node2Y: 2809,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 뒤편2", "신공 9층 뒤편1", 43.2666, 43.2666, "평지", "도보");
  //720
  graph.addEdge("신공 9층 뒤편2", "신공 9층 뒤편3", 15.8114, 15.8114, "평지", "도보",
      node2X: 775,
      node2Y: 2804,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 뒤편3", "신공 9층 뒤편2", 15.8114, 15.8114, "평지", "도보");
  //721
  graph.addEdge("신공 9층 뒤편3", "신공 9층 뒤편4", 38.8973, 38.8973, "평지", "도보",
      node2X: 787,
      node2Y: 2767,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 뒤편4", "신공 9층 뒤편3", 38.8973, 38.8973, "평지", "도보");
  //722
  graph.addEdge("신공 9층 뒤편4", "신공 9층 화장실 왼쪽", 47.5395, 47.5395, "평지", "도보");
  graph.addEdge("신공 9층 화장실 왼쪽", "신공 9층 뒤편4", 47.5395, 47.5395, "평지", "도보");
  //724
  graph.addEdge("신공 9층 뒤편4", "신공 9층 뒤편5", 69.8928, 69.8928, "평지", "도보",
      node2X: 721,
      node2Y: 2744,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 뒤편5", "신공 9층 뒤편4", 69.8928, 69.8928, "평지", "도보");
  //725
  graph.addEdge("신공 9층 뒤편5", "신공 9층 뒤편6", 23.7697, 23.7697, "평지", "도보",
      node2X: 712,
      node2Y: 2766,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 뒤편6", "신공 9층 뒤편5", 23.7697, 23.7697, "평지", "도보");
  //726
  graph.addEdge("신공 9층 뒤편3", "신공 9층 뒤편7", 70.5762, 70.5762, "평지", "도보",
      node2X: 709,
      node2Y: 2779,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 뒤편7", "신공 9층 뒤편3", 70.5762, 70.5762, "평지", "도보");
  //727
  graph.addEdge("신공 9층 뒤편7", "신공 9층 뒤편8", 12.6491, 12.6491, "평지", "도보",
      node2X: 697,
      node2Y: 2775,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 뒤편8", "신공 9층 뒤편7", 12.6491, 12.6491, "평지", "도보");
  //728
  graph.addEdge("신공 9층 뒤편7", "신공 9층 뒤편6", 13.3417, 13.3417, "평지", "도보");
  graph.addEdge("신공 9층 뒤편6", "신공 9층 뒤편7", 13.3417, 13.3417, "평지", "도보");
  //729
  graph.addEdge("신공 9층 뒤편8", "신공 9층 뒷엘베 앞", 13.6015, 13.6015, "평지", "도보",
      node2X: 701,
      node2Y: 2762,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 뒷엘베 앞", "신공 9층 뒤편8", 13.6015, 13.6015, "평지", "도보");
  //730
  graph.addEdge("신공 9층 뒷엘베 앞", "신공 9층 뒤편6", 11.7047, 11.7047, "평지", "도보",
      node2X: 701,
      node2Y: 2762,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 뒤편6", "신공 9층 뒷엘베 앞", 11.7047, 11.7047, "평지", "도보");
  //731
  graph.addEdge("신공 9층 뒷엘베 앞", "신공 9층 뒷엘베", 5.38516, 5.38516, "평지", "도보");
  graph.addEdge("신공 9층 뒷엘베", "신공 9층 뒷엘베 앞", 5.38516, 5.38516, "평지", "도보");
  //732
  graph.addEdge("신공 9층 뒷엘베 앞", "신공 9층 뒷계단", 6.08276, 6.08276, "평지", "도보");
  graph.addEdge("신공 9층 뒷계단", "신공 9층 뒷엘베 앞", 6.08276, 6.08276, "평지", "도보");
//1층 입구
