...
/*    graph.addEdge("Node1 이름", "Node2 이름", 시간 가중치, kcal 가중치, "평지" or "계단위" or "계단아래" or "오르막" or "내리막", "도보" or "차도",
        node1X: Node1 x 픽셀값,
        node1Y: Node1 y 픽셀값,
...
//101
  graph.addEdge("정문 혜화관5", "경영관 차도1", 14.7222, 0.981479, "내리막", "차도",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 차도1", "정문 혜화관5", 16.6606, 1.15108, "오르막", "차도");
//102
  graph.addEdge("경영관 차도1", "경영관 차도2", 14.8928, 0.992851, "내리막", "차도",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 차도2", "경영관 차도1", 17.8273, 1.52128, "오르막", "차도");
//103
...
//129
  ...
  //744
  graph.addEdge("문화관 산책로 입구", "경영관 뒷문 가는길1", 3.91769, 0.26118, "평지", "도보",
      node2X: 2438,
      node2Y: 3100,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 뒷문 가는길1", "문화관 산책로 입구", 3.91769, 0.26118, "평지", "도보");
  //745
  graph.addEdge("경영관 뒷문 가는길1", "경영관 뒷문 가는길2", 8.86248, 0.590832, "평지", "도보",
      node2X: 2478,
      node2Y: 3129,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 뒷문 가는길2", "경영관 뒷문 가는길1", 8.86248, 0.590832, "평지", "도보");
  //746
  graph.addEdge("경영관 뒷문 가는길2", "경영관 뒷문 가는길3", 4.84655, 0.323103, "평지", "도보",
      node2X: 2495,
      node2Y: 3150,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 뒷문 가는길3", "경영관 뒷문 가는길2", 4.84655, 0.323103, "평지", "도보");
  //747
  graph.addEdge("경영관 뒷문 가는길3", "경영관 뒷문 가는길4", 8, 1.2, "계단위", "도보",
      node2X: 2468,
      node2Y: 3149,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 뒷문 가는길4", "경영관 뒷문 가는길3", 5.71429, 0.36, "계단아래", "도보");
  //748
  graph.addEdge("경영관 뒷문 가는길4", "경영관 뒷문 가는길5", 11.3333, 1.7, "계단위", "도보",
      node2X: 2437,
      node2Y: 3146,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 뒷문 가는길5", "경영관 뒷문 가는길4", 8.09524, 0.51, "계단아래", "도보");
  //749
  graph.addEdge("경영관 뒷문 가는길5", "경영관 뒷문 가는길6", 11.3333, 1.7, "계단위", "도보",
      node2X: 2437,
      node2Y: 3146,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 뒷문 가는길6", "경영관 뒷문 가는길5", 8.09524, 0.51, "계단아래", "도보");
  //750
  graph.addEdge("경영관 뒷문 가는길6", "경영관 뒷문 가는길7", 2, 0.3, "계단위", "도보",
      node2X: 2432,
      node2Y: 3145,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 뒷문 가는길7", "경영관 뒷문 가는길6", 1.42857, 0.09, "계단아래", "도보");
  //750
  graph.addEdge("경영관 뒷문 가는길6", "경영관 뒷문 가는길7", 2.33192, 0.155462, "평지", "도보",
      node2X: 2420,
      node2Y: 3140,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 뒷문 가는길7", "경영관 뒷문 가는길6", 2.33192, 0.155462, "평지", "도보");
  //746
  graph.addEdge("경영관 뒷문 가는길7", "경영관 2층 뒷문", 20.6667, 3.1, "계단위", "도보",
      node2X: 2409,
      node2Y: 3137,
      isInside2: 0,
      building2: "실외",
      showRoute2: true);
  graph.addEdge("경영관 2층 뒷문", "경영관 뒷문 가는길7", 14.7619, 0.93, "계단아래", "도보");
//130
  graph.addEdge("문화관 사회과학관 계단 아래", "동대입구 문화관2", 12.4238, 0.828256, "평지", "차도",
      node2X: 2425,
      node2Y: 2658,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("동대입구 문화관2", "문화관 사회과학관 계단 아래", 12.4238, 0.828256, "평지", "차도");
//131-1
  graph.addEdge("동대입구 문화관2", "동대입구 문화관 중간", 11.4085, 0.76057, "평지", "차도",
      node2X: 2463,
      node2Y: 2607,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("동대입구 문화관 중간", "동대입구 문화관2", 11.4085, 0.76057, "평지", "차도");
  //131
  graph.addEdge("동대입구 문화관 중간", "동대입구 문화관1", 15.8585, 1.05724, "내리막", "차도",
      node2X: 2517,
      node2Y: 2537,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("동대입구 문화관1", "동대입구 문화관 중간", 23.7281, 2.75285, "오르막", "차도");
//132
...
//133
  graph.addEdge("동대입구 문화관1", "학술관 입구 앞", 27.2455, 3.16092, "오르막", "도보",
      node2X: 2550,
      node2Y: 2633,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("학술관 입구 앞", "동대입구 문화관1", 18.2094, 1.21396, "내리막", "도보");
//349
...
//142
  graph.addEdge("동대입구 혜화관1", "동대입구 혜화관2", 68.1065, 6.09417, "오르막", "차도",
      node2X: 2290,
      node2Y: 2648,
      isInside2: 0,
      building2: "실외",
...
//143
  graph.addEdge("동대입구 혜화관2", "혜화관 사회과학관 갈림길", 28.3761, 1.9605, "오르막", "차도");
...
//249
  graph.addEdge("학림관 뒷길2", "학림관 뒷길3", 20.1224, 1.3415, "평지", "도보",
      node2X: 1387,
      node2Y: 1715,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("학림관 뒷길3", "학림관 뒷길2", 20.1224, 1.3415, "평지", "도보");
//250
  graph.addEdge("학림관 뒷길3", "학림관 오른쪽 뒷문", 10.7777, 0.718511, "평지", "도보",
      node2X: 1368,
      node2Y: 1772,
      isInside2: 0,
      building2: "실외",
      showRoute2: true);
  graph.addEdge("학림관 오른쪽 뒷문", "학림관 뒷길3", 10.7777, 0.718511, "평지", "도보");
//251
...
//333
  ...
  //736
  graph.addEdge("체육관 옆문 앞", "체육관쪽 입구6", 7.38074, 0.492049, "평지", "도보",
      node2X: 1306,
      node2Y: 2036,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("체육관쪽 입구6", "체육관 옆문 앞", 7.38074, 0.492049, "평지", "도보");
  //737
  graph.addEdge("체육관쪽 입구6", "체육관쪽 입구5", 14, 0.45, "계단아래", "도보",
      node2X: 1312,
      node2Y: 2086,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("체육관쪽 입구5", "체육관쪽 입구6", 10, 1.5, "계단위", "도보");
  //738
  graph.addEdge("체육관쪽 입구5", "체육관쪽 입구4", 1.90476, 0.12, "계단아래", "도보",
      node2X: 1321,
      node2Y: 2097,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("체육관쪽 입구4", "체육관쪽 입구5", 2.66667, 0.4, "계단위", "도보");
  //739
  graph.addEdge("체육관쪽 입구4", "체육관쪽 입구3", 13.7198, 0.914656, "평지", "도보",
      node2X: 1396,
      node2Y: 2112,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("체육관쪽 입구3", "체육관쪽 입구4", 13.7198, 0.914656, "평지", "도보");
  //740
  graph.addEdge("체육관쪽 입구3", "체육관쪽 입구2", 8.83338, 0.588892, "평지", "도보",
      node2X: 1416,
      node2Y: 2157,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("체육관쪽 입구2", "체육관쪽 입구3", 8.83338, 0.588892, "평지", "도보");
  //741
  graph.addEdge("체육관쪽 입구2", "체육관쪽 입구1", 7.88043, 0.525362, "평지", "도보",
      node2X: 1459,
      node2Y: 2166,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("체육관쪽 입구1", "체육관쪽 입구2", 7.88043, 0.525362, "평지", "도보");
  //742
  ...
  //2층 입구
  graph.addEdge("정P 2층 입구", "정보문화관p 2층", 100000, 100000, "평지", "도보",
      node2X: 857,
      node2Y: 2058,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("정보문화관p 2층", "정P 2층 입구", 100000, 100000, "평지", "도보");
  //정P 2층 엘베
  graph.addEdge("정P 2층 엘베", "정보문화관p 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("정보문화관p 2층", "정P 2층 엘베", 100000, 100000, "평지", "도보");
  //정P 2층 엘베
  graph.addEdge("정P 내 2층 계단", "정보문화관p 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("정보문화관p 2층", "정P 내 2층 계단", 100000, 100000, "평지", "도보");
  //3층 입구
  graph.addEdge("정P 3층 입구", "정보문화관p 3층", 100000, 100000, "평지", "도보",
      node2X: 857,
      node2Y: 2058,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("정보문화관p 3층", "정P 3층 입구", 100000, 100000, "평지", "도보");
  //3층 엘베
  graph.addEdge("정P 3층 엘베", "정보문화관p 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("정보문화관p 3층", "정P 3층 엘베", 100000, 100000, "평지", "도보");
  //3층 엘베
  graph.addEdge("정P 내 3층 계단", "정보문화관p 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("정보문화관p 3층", "정P 내 3층 계단", 100000, 100000, "평지", "도보");
  //정P 3층 후문
  graph.addEdge("정P 3층 후문", "정보문화관p 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("정보문화관p 3층", "정P 3층 후문", 100000, 100000, "평지", "도보");
  //**************************************************************************
  //신공학관
...
//348
  ...
  //660-1
  graph.addEdge("신공 3층 오른쪽 위", "신공 3층 계단 앞", 6.4676, 0.431173, "평지", "도보",
      node2X: 864,
      node2Y: 2675,
      isInside2: 3,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 3층 계단 앞", "신공 3층 오른쪽 위", 6.4676, 0.431173, "평지", "도보");
  //660-2
  graph.addEdge("신공 3층 계단 앞", "신공 3층 계단", 0.914656, 0.0609771, "평지", "도보",
      node2X: 859,
      node2Y: 2674,
      isInside2: 3,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 3층 계단", "신공 3층 계단 앞", 0.914656, 0.0609771, "평지", "도보");
  //660-3
  graph.addEdge("신공 3층 계단 앞", "신공 3층 화장실 오른쪽", 11.9701, 0.798006, "평지", "도보",
      node2X: 842,
      node2Y: 2738,
      isInside2: 3,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 3층 화장실 오른쪽", "신공 3층 계단 앞", 11.9701, 0.798006, "평지", "도보");
  //661
  ...
  //685-1
  graph.addEdge("신공 7층 오른쪽 위", "신공 7층 계단 앞", 4.93536, 0.329024, "평지", "도보",
      node2X: 864,
      node2Y: 2675,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 계단 앞", "신공 7층 오른쪽 위", 4.93536, 0.329024, "평지", "도보");
  //685-2
  graph.addEdge("신공 7층 계단 앞", "신공 7층 계단", 0.914656, 0.0609771, "평지", "도보",
      node2X: 859,
      node2Y: 2674,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 계단", "신공 7층 계단 앞", 0.914656, 0.0609771, "평지", "도보");
  //685-3
  graph.addEdge("신공 7층 계단 앞", "신공 7층 화장실 오른쪽", 11.9701, 0.798006, "평지", "도보",
      node2X: 842,
      node2Y: 2738,
      isInside2: 7,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 7층 화장실 오른쪽", "신공 7층 계단 앞", 11.9701, 0.798006, "평지", "도보");
  //686
  ...
  //716-1
  graph.addEdge("신공 9층 오른쪽 위", "신공 9층 계단 앞", 4.93536, 0.329024, "평지", "도보",
      node2X: 864,
      node2Y: 2675,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 계단 앞", "신공 9층 오른쪽 위", 4.93536, 0.329024, "평지", "도보");
  //716-2
  graph.addEdge("신공 9층 계단 앞", "신공 9층 계단", 0.914656, 0.0609771, "평지", "도보",
      node2X: 859,
      node2Y: 2674,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 계단", "신공 9층 계단 앞", 0.914656, 0.0609771, "평지", "도보");
  //716-3
  graph.addEdge("신공 9층 계단 앞", "신공 9층 화장실 오른쪽", 11.9701, 0.798006, "평지", "도보",
      node2X: 842,
      node2Y: 2738,
      isInside2: 9,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("신공 9층 화장실 오른쪽", "신공 9층 계단 앞", 11.9701, 0.798006, "평지", "도보");
  //717
...
//3층 입구
  ...
  //신공학관 1층
  //신공 1층 입구
  graph.addEdge("신공 1층 입구", "신공학관 1층", 100000, 100000, "평지", "도보",
      node2X: 714,
      node2Y: 2657,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("신공학관 1층", "신공 1층 입구", 100000, 100000, "평지", "도보");
  //신공 1층 옆문
  graph.addEdge("신공 1층 옆문", "신공학관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 1층", "신공 1층 옆문", 100000, 100000, "평지", "도보");
  //신공 1층 뒷계단
  graph.addEdge("신공 1층 뒷계단", "신공학관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 1층", "신공 1층 뒷계단", 100000, 100000, "평지", "도보");
  //신공 1층 뒷엘베
  graph.addEdge("신공 1층 뒷엘베", "신공학관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 1층", "신공 1층 뒷엘베", 100000, 100000, "평지", "도보");
  //신공 1층 계단
  graph.addEdge("신공 1층 계단", "신공학관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 1층", "신공 1층 계단", 100000, 100000, "평지", "도보");
  //신공 1층 9층 엘베
  graph.addEdge("신공 1층 9층 엘베", "신공학관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 1층", "신공 1층 9층 엘베", 100000, 100000, "평지", "도보");
  //신공 1층 전층 엘베
  graph.addEdge("신공 1층 전층 엘베", "신공학관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 1층", "신공 1층 전층 엘베", 100000, 100000, "평지", "도보");

  //신공학관 3층
  //신공 3층 입구
  graph.addEdge("신공 3층 입구", "신공학관 3층", 100000, 100000, "평지", "도보",
      node2X: 714,
      node2Y: 2657,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("신공학관 3층", "신공 3층 입구", 100000, 100000, "평지", "도보");
  //신공 3층 입구 계단 안쪽 문
  graph.addEdge("신공 3층 입구 계단 안쪽 문", "신공학관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 3층", "신공 3층 입구 계단 안쪽 문", 100000, 100000, "평지", "도보");
  //신공 3층 전층 엘베
  graph.addEdge("신공 3층 전층 엘베", "신공학관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 3층", "신공 3층 전층 엘베", 100000, 100000, "평지", "도보");
  //신공 3층 뒷계단
  graph.addEdge("신공 3층 뒷계단", "신공학관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 3층", "신공 3층 뒷계단", 100000, 100000, "평지", "도보");
  //신공 3층 뒷엘베
  graph.addEdge("신공 3층 뒷엘베", "신공학관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 3층", "신공 3층 뒷엘베", 100000, 100000, "평지", "도보");

  //신공학관 7층
  //신공 7층 입구
  graph.addEdge("신공 7층 입구", "신공학관 7층", 100000, 100000, "평지", "도보",
      node2X: 714,
      node2Y: 2657,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("신공학관 7층", "신공 7층 입구", 100000, 100000, "평지", "도보");
  //신공 7층 입구 계단 문
  graph.addEdge("신공 7층 입구 계단 문", "신공학관 7층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 7층", "신공 7층 입구 계단 문", 100000, 100000, "평지", "도보");
  //신공 7층 전층 엘베
  graph.addEdge("신공 7층 전층 엘베", "신공학관 7층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 7층", "신공 7층 전층 엘베", 100000, 100000, "평지", "도보");
  //신공 7층 계단
  graph.addEdge("신공 7층 계단", "신공학관 7층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 7층", "신공 7층 계단", 100000, 100000, "평지", "도보");
  //신공 7층 뒷계단
  graph.addEdge("신공 7층 뒷계단", "신공학관 7층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 7층", "신공 7층 뒷계단", 100000, 100000, "평지", "도보");
  //신공 7층 뒷엘베
  graph.addEdge("신공 7층 뒷엘베", "신공학관 7층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 7층", "신공 7층 뒷엘베", 100000, 100000, "평지", "도보");

  //신공학관 9층
  //신공 9층 입구
  graph.addEdge("신공 9층 입구", "신공학관 9층", 100000, 100000, "평지", "도보",
      node2X: 714,
      node2Y: 2657,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("신공학관 9층", "신공 9층 입구", 100000, 100000, "평지", "도보");
  //신공 9층 9층 엘베
  graph.addEdge("신공 9층 9층 엘베", "신공학관 9층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 9층", "신공 9층 9층 엘베", 100000, 100000, "평지", "도보");
  //신공 9층 전층 엘베
  graph.addEdge("신공 9층 전층 엘베", "신공학관 9층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 9층", "신공 9층 전층 엘베", 100000, 100000, "평지", "도보");
  //신공 9층 계단
  graph.addEdge("신공 9층 계단", "신공학관 9층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 9층", "신공 9층 계단", 100000, 100000, "평지", "도보");
  //신공 9층 뒷계단
  graph.addEdge("신공 9층 뒷계단", "신공학관 9층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 9층", "신공 9층 뒷계단", 100000, 100000, "평지", "도보");
  //신공 9층 뒷엘베
  graph.addEdge("신공 9층 뒷엘베", "신공학관 9층", 100000, 100000, "평지", "도보");
  graph.addEdge("신공학관 9층", "신공 9층 뒷엘베", 100000, 100000, "평지", "도보");
  //**************************************************************************
  //법학관_만해관
  ...
  //입구
  graph.addEdge("학림관 입구", "학림관 1층", 100000, 100000, "평지", "도보",
      node2X: 1265,
      node2Y: 1758,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("학림관 1층", "학림관 입구", 100000, 100000, "평지", "도보");
  //우측 앞문
  graph.addEdge("학림관 우측 앞문", "학림관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("학림관 1층", "학림관 우측 앞문", 100000, 100000, "평지", "도보");
  //오른쪽 뒷문
  graph.addEdge("학림관 오른쪽 뒷문", "학림관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("학림관 1층", "학림관 오른쪽 뒷문", 100000, 100000, "평지", "도보");
  //뒷문
  graph.addEdge("학림관 뒷문", "학림관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("학림관 1층", "학림관 뒷문", 100000, 100000, "평지", "도보");
  //좌측 앞문
  graph.addEdge("학림관 좌측 앞문", "학림관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("학림관 1층", "학림관 좌측 앞문", 100000, 100000, "평지", "도보");
  //좌측 앞문
  graph.addEdge("학림관 1층 엘베", "학림관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("학림관 1층", "학림관 1층 엘베", 100000, 100000, "평지", "도보");
  //편의점 입구
  graph.addEdge("학림관 편의점 입구", "학림관 B1층", 100000, 100000, "평지", "도보",
      node2X: 1265,
      node2Y: 1758,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("학림관 B1층", "학림관 편의점 입구", 100000, 100000, "평지", "도보");
  //B1 엘베
  graph.addEdge("학림관 B1 엘베", "학림관 B1층", 100000, 100000, "평지", "도보");
  graph.addEdge("학림관 B1층", "학림관 B1 엘베", 100000, 100000, "평지", "도보");
  //왼쪽 뒷문
  graph.addEdge("학림관 왼쪽 뒷문", "학림관 B1층", 100000, 100000, "평지", "도보");
  graph.addEdge("학림관 B1층", "학림관 왼쪽 뒷문", 100000, 100000, "평지", "도보");
  ...
  //혜화관 입구
  graph.addEdge("혜화관 입구", "혜화관 1층", 100000, 100000, "평지", "도보",
      node2X: 1993,
      node2Y: 2884,
      isInside2: 0,
      building2: "혜화관",
      showRoute2: false);
  graph.addEdge("혜화관 1층", "혜화관 입구", 100000, 100000, "평지", "도보");
  //혜화관 4층 입구
  graph.addEdge("혜화관 4층 입구", "혜화관 4층", 100000, 100000, "평지", "도보",
      node2X: 1993,
      node2Y: 2884,
      isInside2: 0,
      building2: "혜화관",
      showRoute2: false);
  graph.addEdge("혜화관 4층", "혜화관 4층 입구", 100000, 100000, "평지", "도보");
  //혜화관 4층 엘베
  graph.addEdge("혜화관 4층 엘베", "혜화관 4층", 100000, 100000, "평지", "도보");
  graph.addEdge("혜화관 4층", "혜화관 4층 엘베", 100000, 100000, "평지", "도보");
  //혜화관 3층 계단
  graph.addEdge("혜화관 3층 계단", "혜화관 4층", 100000, 100000, "평지", "도보");
  graph.addEdge("혜화관 4층", "혜화관 3층 계단", 100000, 100000, "평지", "도보");
  //혜화관 1층 엘베
  graph.addEdge("혜화관 1층 엘베", "혜화관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("혜화관 1층", "혜화관 1층 엘베", 100000, 100000, "평지", "도보");
  //혜화관 1층 계단
  graph.addEdge("혜화관 1층 계단", "혜화관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("혜화관 1층", "혜화관 1층 계단", 100000, 100000, "평지", "도보");
  ...
  //444
  graph.addEdge("경영관 2층 뒷문 안", "경영관 문화관 구름다리 앞", 8.50868, 0.567246, "평지", "도보",
      node2X: 2338,
      node2Y: 3115,
      isInside2: 2,
      building2: "사회과학관_경영관",
      showRoute2: false);
  graph.addEdge("경영관 문화관 구름다리 앞", "경영관 2층 뒷문 안", 8.50868, 0.567246, "평지", "도보");
  //445
  graph.addEdge("경영관 문화관 구름다리 앞", "경영관 문화관 구름다리 입구", 6.97735, 0.465157, "평지", "도보",
      node2X: 2350,
      node2Y: 3078,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 문화관 구름다리 입구", "경영관 문화관 구름다리 앞", 6.97735, 0.465157, "평지", "도보");
  //경영관 문화관 구름다리 이동
  ...
  //446
  graph.addEdge("경영관 문화관 구름다리 앞", "사회과학관 2층 옆문 안", 18.8894, 1.25929, "평지", "도보",
      node2X: 2238,
      node2Y: 3082,
      isInside2: 2,
      building2: "사회과학관_경영관",
      showRoute2: false);
  graph.addEdge("사회과학관 2층 옆문 안", "경영관 문화관 구름다리 앞", 18.8894, 1.25929, "평지", "도보");
  //447
  ...
  //464-1
  graph.addEdge("경영관 3층 계단 옆", "사회과학관 경영관 3층 경계", 8.50868, 0.567246, "평지", "도보",
      node2X: 2338,
      node2Y: 3115,
      isInside2: 3,
      building2: "사회과학관_경영관",
      showRoute2: false);
  graph.addEdge("사회과학관 경영관 3층 경계", "경영관 3층 계단 옆", 8.50868, 0.567246, "평지", "도보");
  //464-2
  graph.addEdge("사회과학관 경영관 3층 경계", "사회과학관 3층 계단 오른쪽", 18.8894, 1.25929, "평지", "도보",
      node2X: 2238,
      node2Y: 3082,
      isInside2: 3,
      building2: "사회과학관_경영관",
      showRoute2: false);
  graph.addEdge("사회과학관 3층 계단 오른쪽", "사회과학관 경영관 3층 경계", 18.8894, 1.25929, "평지", "도보");
  //465
  ...
  //사회과학관 2층
  //사회과학관 2층 쪽문 계단 앞
  graph.addEdge("사회과학관 2층 쪽문 계단 앞", "사회과학관 2층", 100000, 100000, "평지", "도보",
      node2X: 2249,
      node2Y: 2954,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("사회과학관 2층", "사회과학관 2층 쪽문 계단 앞", 100000, 100000, "평지", "도보");
  //사회과학관 2층 엘베
  graph.addEdge("사회과학관 2층 엘베", "사회과학관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("사회과학관 2층", "사회과학관 2층 엘베", 100000, 100000, "평지", "도보");
  //사회과학관 2층 계단
  graph.addEdge("사회과학관 2층 계단", "사회과학관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("사회과학관 2층", "사회과학관 2층 계단", 100000, 100000, "평지", "도보");
  //사회과학관 2층 옆문
  graph.addEdge("사회과학관 2층 옆문", "사회과학관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("사회과학관 2층", "사회과학관 2층 옆문", 100000, 100000, "평지", "도보");
  //경영관 문화관 구름다리 앞
  graph.addEdge("경영관 문화관 구름다리 앞", "사회과학관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("사회과학관 2층", "경영관 문화관 구름다리 앞", 100000, 100000, "평지", "도보");

  //사회과학관 3층
  //사회과학관 3층 쪽문 계단 앞
  graph.addEdge("사회과학관 3층 쪽문 계단 앞", "사회과학관 3층", 100000, 100000, "평지", "도보",
      node2X: 2249,
      node2Y: 2954,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("사회과학관 3층", "사회과학관 3층 쪽문 계단 앞", 100000, 100000, "평지", "도보");
  //사회과학관 3층 엘베
  graph.addEdge("사회과학관 3층 엘베", "사회과학관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("사회과학관 3층", "사회과학관 3층 엘베", 100000, 100000, "평지", "도보");
  //사회과학관 3층 계단
  graph.addEdge("사회과학관 3층 계단", "사회과학관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("사회과학관 3층", "사회과학관 3층 계단", 100000, 100000, "평지", "도보");
  //사회과학관 3층 입구
  graph.addEdge("사회과학관 3층 입구", "사회과학관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("사회과학관 2층", "사회과학관 3층 입구", 100000, 100000, "평지", "도보");
  //사회과학관 경영관 3층 경계
  graph.addEdge("사회과학관 경영관 3층 경계", "사회과학관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("사회과학관 2층", "사회과학관 경영관 3층 경계", 100000, 100000, "평지", "도보");

  //경영관 2층
  //경영관 2층 입구
  graph.addEdge("경영관 2층 입구", "경영관 2층", 100000, 100000, "평지", "도보",
      node2X: 2361,
      node2Y: 3204,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 2층", "경영관 2층 입구", 100000, 100000, "평지", "도보");
  //경영관 문화관 구름다리 앞
  graph.addEdge("경영관 문화관 구름다리 앞", "경영관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("경영관 2층", "경영관 문화관 구름다리 앞", 100000, 100000, "평지", "도보");
  //경영관 2층 뒷문
  graph.addEdge("경영관 2층 뒷문", "경영관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("경영관 2층", "경영관 2층 뒷문", 100000, 100000, "평지", "도보");
  //경영관 2층 계단
  graph.addEdge("경영관 2층 계단", "경영관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("경영관 2층", "경영관 2층 계단", 100000, 100000, "평지", "도보");
  //경영관 2층 쪽문
  graph.addEdge("경영관 2층 쪽문", "경영관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("경영관 2층", "경영관 2층 쪽문", 100000, 100000, "평지", "도보");

  //경영관 3층
  //사회과학관 경영관 3층 경계
  graph.addEdge("사회과학관 경영관 3층 경계", "경영관 3층", 100000, 100000, "평지", "도보",
      node2X: 2361,
      node2Y: 3204,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 3층", "사회과학관 경영관 3층 경계", 100000, 100000, "평지", "도보");
  //경영관 3층 계단
  graph.addEdge("경영관 3층 계단", "경영관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("경영관 3층", "경영관 3층 계단", 100000, 100000, "평지", "도보");
  //경영관 3층 쪽문
  graph.addEdge("경영관 3층 쪽문", "경영관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("경영관 3층", "경영관 3층 쪽문", 100000, 100000, "평지", "도보");
...
//명진관 우측 입구
  ...
  //문화관 1층
  //문화관 1층 입구
  graph.addEdge("문화관 1층 입구", "문화관 1층", 100000, 100000, "평지", "도보",
      node2X: 2422,
      node2Y: 2841,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("문화관 1층", "문화관 1층 입구", 100000, 100000, "평지", "도보");
  //문화관 후문
  graph.addEdge("문화관 후문", "문화관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("문화관 1층", "문화관 후문", 100000, 100000, "평지", "도보");
  //문화관 1층 계단
  graph.addEdge("문화관 1층 계단", "문화관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("문화관 1층", "문화관 1층 계단", 100000, 100000, "평지", "도보");
  //문화관 1층 쪽문 계단
  graph.addEdge("문화관 1층 쪽문 계단", "문화관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("문화관 1층", "문화관 1층 쪽문 계단", 100000, 100000, "평지", "도보");
  //문화관 쪽문
  graph.addEdge("문화관 쪽문", "문화관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("문화관 1층", "문화관 쪽문", 100000, 100000, "평지", "도보");

  //문화관 3층
  //문화관 3층 계단
  graph.addEdge("문화관 3층 계단", "문화관 3층", 100000, 100000, "평지", "도보",
      node2X: 2422,
      node2Y: 2841,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("문화관 3층", "문화관 3층 계단", 100000, 100000, "평지", "도보");
  //문화관 3층 쪽문 계단
  graph.addEdge("문화관 3층 쪽문 계단", "문화관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("문화관 3층", "문화관 3층 쪽문 계단", 100000, 100000, "평지", "도보");
  //문화관 경영관 구름다리 입구
  graph.addEdge("문화관 경영관 구름다리 입구", "문화관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("문화관 3층", "문화관 경영관 구름다리 입구", 100000, 100000, "평지", "도보");

  //문화관 4층
  //문화관 4층 계단
  graph.addEdge("문화관 4층 계단", "문화관 4층", 100000, 100000, "평지", "도보",
      node2X: 2422,
      node2Y: 2841,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("문화관 4층", "문화관 4층 계단", 100000, 100000, "평지", "도보");
  //문화관 학술관 구름다리 입구
  graph.addEdge("문화관 학술관 구름다리 입구", "문화관 4층", 100000, 100000, "평지", "도보");
  graph.addEdge("문화관 4층", "문화관 학술관 구름다리 입구", 100000, 100000, "평지", "도보");
  //문화관 4층 쪽문 계단
  graph.addEdge("문화관 4층 쪽문 계단", "문화관 4층", 100000, 100000, "평지", "도보");
  graph.addEdge("문화관 4층", "문화관 4층 쪽문 계단", 100000, 100000, "평지", "도보");

  //문화관 B1층
  //문화관 B1 쪽문 계단
  graph.addEdge("문화관 B1 쪽문 계단", "문화관 B1층", 100000, 100000, "평지", "도보",
      node2X: 2422,
      node2Y: 2841,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("문화관 B1층", "문화관 B1 쪽문 계단", 100000, 100000, "평지", "도보");
  //문화관 B1 계단
  graph.addEdge("문화관 B1 계단", "문화관 B1층", 100000, 100000, "평지", "도보");
  graph.addEdge("문화관 B1층", "문화관 B1 계단", 100000, 100000, "평지", "도보");
  //가든쿡 문화관 입구
  graph.addEdge("가든쿡 문화관 입구", "문화관 B1층", 100000, 100000, "평지", "도보");
  graph.addEdge("문화관 B1층", "가든쿡 문화관 입구", 100000, 100000, "평지", "도보");
  //문화관 학술관 B1 경계
  graph.addEdge("문화관 학술관 B1 경계", "문화관 B1층", 100000, 100000, "평지", "도보");
  graph.addEdge("문화관 B1층", "문화관 학술관 B1 경계", 100000, 100000, "평지", "도보");
  ...
  //학술관 1층
  //학술관 입구
  graph.addEdge("학술관 입구", "학술관 1층", 100000, 100000, "평지", "도보",
      node2X: 2597,
      node2Y: 2719,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("학술관 1층", "학술관 입구", 100000, 100000, "평지", "도보");
  //학술관 1층 계단
  graph.addEdge("학술관 1층 계단", "학술관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("학술관 1층", "학술관 1층 계단", 100000, 100000, "평지", "도보");
  //학술관 옆문
  graph.addEdge("학술관 옆문", "학술관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("학술관 1층", "학술관 옆문", 100000, 100000, "평지", "도보");
  //학술관 1층 뒷계단
  graph.addEdge("학술관 1층 뒷계단", "학술관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("학술관 1층", "학술관 1층 뒷계단", 100000, 100000, "평지", "도보");

  //학술관 4층
  //학술관 문화관 구름다리 입구
  graph.addEdge("학술관 문화관 구름다리 입구", "학술관 4층", 100000, 100000, "평지", "도보",
      node2X: 2597,
      node2Y: 2719,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("학술관 4층", "학술관 문화관 구름다리 입구", 100000, 100000, "평지", "도보");
  //학술관 4층 뒷계단
  graph.addEdge("학술관 4층 뒷계단", "학술관 4층", 100000, 100000, "평지", "도보");
  graph.addEdge("학술관 4층", "학술관 4층 뒷계단", 100000, 100000, "평지", "도보");
  //학술관 4층 계단
  graph.addEdge("학술관 4층 계단", "학술관 4층", 100000, 100000, "평지", "도보");
  graph.addEdge("학술관 4층", "학술관 4층 계단", 100000, 100000, "평지", "도보");

  //학술관 B1층
  //문화관 학술관 B1 경계
  graph.addEdge("문화관 학술관 B1 경계", "학술관 B1층", 100000, 100000, "평지", "도보",
      node2X: 2597,
      node2Y: 2719,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("학술관 B1층", "문화관 학술관 B1 경계", 100000, 100000, "평지", "도보");
  //학술관 B1 계단
  graph.addEdge("학술관 B1 계단", "학술관 B1층", 100000, 100000, "평지", "도보");
  graph.addEdge("학술관 B1층", "학술관 B1 계단", 100000, 100000, "평지", "도보");
  //학술관 B1 뒷계단
  graph.addEdge("학술관 B1 뒷계단", "학술관 B1층", 100000, 100000, "평지", "도보");
  graph.addEdge("학술관 B1층", "학술관 B1 뒷계단", 100000, 100000, "평지", "도보");
  //가든쿡 학술관 입구
  graph.addEdge("가든쿡 학술관 입구", "학술관 B1층", 100000, 100000, "평지", "도보");
  graph.addEdge("학술관 B1층", "가든쿡 학술관 입구", 100000, 100000, "평지", "도보");
  ...
  //원흥관 1층
  //원흥관 1층 후문
  graph.addEdge("원흥관 1층 후문", "원흥관 1층", 100000, 100000, "평지", "도보",
      node2X: 953,
      node2Y: 2405,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("원흥관 1층", "원흥관 1층 후문", 100000, 100000, "평지", "도보");
  //원흥관 1층 정문
  graph.addEdge("원흥관 1층 정문", "원흥관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 1층", "원흥관 1층 정문", 100000, 100000, "평지", "도보");
  //원흥관 1층 쪽문
  graph.addEdge("원흥관 1층 쪽문", "원흥관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 1층", "원흥관 1층 쪽문", 100000, 100000, "평지", "도보");
  //원흥관 1층 쪽문 계단
  graph.addEdge("원흥관 1층 쪽문 계단", "원흥관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 1층", "원흥관 1층 쪽문 계단", 100000, 100000, "평지", "도보");
  //원흥관 1층 쪽문 계단
  graph.addEdge("원흥관 1층 후문 계단", "원흥관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 1층", "원흥관 1층 후문 계단", 100000, 100000, "평지", "도보");
  //원흥관 1층 쪽문 계단
  graph.addEdge("원흥관 1층 중앙 계단", "원흥관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 1층", "원흥관 1층 중앙 계단", 100000, 100000, "평지", "도보");

  //원흥관 2층
  //원흥관 2층 쪽문 계단
  graph.addEdge("원흥관 2층 쪽문 계단", "원흥관 2층", 100000, 100000, "평지", "도보",
      node2X: 953,
      node2Y: 2405,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("원흥관 2층", "원흥관 2층 쪽문 계단", 100000, 100000, "평지", "도보");
  //원흥관 2층 후문 계단
  graph.addEdge("원흥관 2층 후문 계단", "원흥관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 2층", "원흥관 2층 후문 계단", 100000, 100000, "평지", "도보");
  //원흥관 2층 중앙 계단
  graph.addEdge("원흥관 2층 중앙 계단", "원흥관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 2층", "원흥관 2층 중앙 계단", 100000, 100000, "평지", "도보");
  //원흥관 2층 엘베
  graph.addEdge("원흥관 2층 엘베", "원흥관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 2층", "원흥관 2층 엘베", 100000, 100000, "평지", "도보");

  //원흥관 3층
  //원흥관 3층 쪽문 계단
  graph.addEdge("원흥관 3층 쪽문 계단", "원흥관 3층", 100000, 100000, "평지", "도보",
      node2X: 953,
      node2Y: 2405,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("원흥관 3층", "원흥관 3층 쪽문 계단", 100000, 100000, "평지", "도보");
  //원흥관 3층 후문 계단
  graph.addEdge("원흥관 3층 후문 계단", "원흥관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 3층", "원흥관 3층 후문 계단", 100000, 100000, "평지", "도보");
  //원흥관 3층 중앙 계단
  graph.addEdge("원흥관 3층 중앙 계단", "원흥관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 3층", "원흥관 3층 중앙 계단", 100000, 100000, "평지", "도보");
  //원흥관 3층 엘베
  graph.addEdge("원흥관 3층 엘베", "원흥관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 3층", "원흥관 3층 엘베", 100000, 100000, "평지", "도보");
  //원흥관 3층 오른쪽 계단
  graph.addEdge("원흥관 3층 오른쪽 계단", "원흥관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 3층", "원흥관 3층 오른쪽 계단", 100000, 100000, "평지", "도보");
  //원흥관 3층 후문
  graph.addEdge("원흥관 3층 후문", "원흥관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 3층", "원흥관 3층 후문", 100000, 100000, "평지", "도보");
  //원흥관 3층 야외 계단문
  graph.addEdge("원흥관 3층 야외 계단문", "원흥관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 3층", "원흥관 3층 야외 계단문", 100000, 100000, "평지", "도보");

  //원흥관 4층
  //원흥관 4층 쪽문 계단
  graph.addEdge("원흥관 4층 쪽문 계단", "원흥관 4층", 100000, 100000, "평지", "도보",
      node2X: 953,
      node2Y: 2405,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("원흥관 4층", "원흥관 4층 쪽문 계단", 100000, 100000, "평지", "도보");
  //원흥관 4층 후문 계단
  graph.addEdge("원흥관 4층 후문 계단", "원흥관 4층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 4층", "원흥관 4층 후문 계단", 100000, 100000, "평지", "도보");
  //원흥관 4층 중앙 계단
  graph.addEdge("원흥관 4층 중앙 계단", "원흥관 4층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 4층", "원흥관 3층 중앙 계단", 100000, 100000, "평지", "도보");
  //원흥관 4층 엘베
  graph.addEdge("원흥관 4층 엘베", "원흥관 4층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 4층", "원흥관 4층 엘베", 100000, 100000, "평지", "도보");
  //원흥관 4층 입구
  graph.addEdge("원흥관 4층 입구", "원흥관 4층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 4층", "원흥관 4층 입구", 100000, 100000, "평지", "도보");
  //원흥관 4층 오른쪽 계단
  graph.addEdge("원흥관 4층 오른쪽 계단", "원흥관 4층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 4층", "원흥관 4층 오른쪽 계단", 100000, 100000, "평지", "도보");
  //원흥관 4층 야외 계단문
  graph.addEdge("원흥관 4층 야외 계단문", "원흥관 4층", 100000, 100000, "평지", "도보");
  graph.addEdge("원흥관 4층", "원흥관 4층 야외 계단문", 100000, 100000, "평지", "도보");
  //**************************************************************************
  //본관
  ...
  //본관 1층
  //본관 1층 입구
  graph.addEdge("본관 1층 입구", "본관 1층", 100000, 100000, "평지", "도보",
      node2X: 1149,
      node2Y: 2551,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("본관 1층", "본관 1층 입구", 100000, 100000, "평지", "도보");
  //본관 1층 엘베
  graph.addEdge("본관 1층 엘베", "본관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 1층", "본관 1층 엘베", 100000, 100000, "평지", "도보");
  //본관 1층 왼쪽 계단
  graph.addEdge("본관 1층 왼쪽 계단", "본관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 1층", "본관 1층 왼쪽 계단", 100000, 100000, "평지", "도보");
  //본관 1층 중앙 계단
  graph.addEdge("본관 1층 중앙 계단", "본관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 1층", "본관 1층 중앙 계단", 100000, 100000, "평지", "도보");
  //본관 1층 오른쪽 계단
  graph.addEdge("본관 1층 오른쪽 계단", "본관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 1층", "본관 1층 오른쪽 계단", 100000, 100000, "평지", "도보");
  //본관 1층 쪽문
  graph.addEdge("본관 1층 쪽문", "본관 1층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 1층", "본관 1층 쪽문", 100000, 100000, "평지", "도보");

  //본관 2층
  //본관 2층 엘베
  graph.addEdge("본관 2층 엘베", "본관 2층", 100000, 100000, "평지", "도보",
      node2X: 1149,
      node2Y: 2551,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("본관 2층", "본관 2층 엘베", 100000, 100000, "평지", "도보");
  //본관 2층 왼쪽 계단
  graph.addEdge("본관 2층 왼쪽 계단", "본관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 2층", "본관 2층 왼쪽 계단", 100000, 100000, "평지", "도보");
  //본관 2층 구석 계단
  graph.addEdge("본관 2층 구석 계단", "본관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 2층", "본관 2층 구석 계단", 100000, 100000, "평지", "도보");
  //본관 2층 중앙 계단
  graph.addEdge("본관 2층 중앙 계단", "본관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 2층", "본관 2층 중앙 계단", 100000, 100000, "평지", "도보");
  //본관 2층 오른쪽 계단
  graph.addEdge("본관 2층 오른쪽 계단", "본관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 2층", "본관 2층 오른쪽 계단", 100000, 100000, "평지", "도보");
  //본관 2층 중도 쪽문
  graph.addEdge("본관 2층 중도 쪽문", "본관 2층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 2층", "본관 2층 중도 쪽문", 100000, 100000, "평지", "도보");

  //본관 3층
  //본관 3층 엘베
  graph.addEdge("본관 3층 엘베", "본관 3층", 100000, 100000, "평지", "도보",
      node2X: 1149,
      node2Y: 2551,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("본관 3층", "본관 3층 엘베", 100000, 100000, "평지", "도보");
  //본관 3층 왼쪽 계단
  graph.addEdge("본관 3층 왼쪽 계단", "본관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 3층", "본관 3층 왼쪽 계단", 100000, 100000, "평지", "도보");
  //본관 3층 구석 계단
  graph.addEdge("본관 3층 구석 계단", "본관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 3층", "본관 3층 구석 계단", 100000, 100000, "평지", "도보");
  //본관 3층 오른쪽 입구
  graph.addEdge("본관 3층 오른쪽 입구", "본관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 3층", "본관 3층 오른쪽 입구", 100000, 100000, "평지", "도보");
  //본관 3층 왼쪽 입구
  graph.addEdge("본관 3층 왼쪽 입구", "본관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 3층", "본관 3층 왼쪽 입구", 100000, 100000, "평지", "도보");
  //본관 3층 오른쪽 계단
  graph.addEdge("본관 3층 오른쪽 계단", "본관 3층", 100000, 100000, "평지", "도보");
  graph.addEdge("본관 3층", "본관 3층 오른쪽 계단", 100000, 100000, "평지", "도보");
  //**************************************************************************
  //다향관
