...
//104
  graph.addEdge("경영관 차도3", "경영관 쪽문 앞", 42, "평지", "도보",
      node2X: 2243,
      node2Y: 3296,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 쪽문 앞", "경영관 차도3", 42, "평지", "도보");
  //423
  graph.addEdge("경영관 쪽문 앞", "경영관 쪽문", 11, "평지", "도보",
      node2X: 2254,
      node2Y: 3293,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 쪽문", "경영관 쪽문 앞", 11, "평지", "도보");
  //424
  graph.addEdge("경영관 쪽문 앞", "경영관 2층 쪽문 계단", 5, "평지", "도보",
      node2X: 2246,
      node2Y: 3300,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("경영관 2층 쪽문 계단", "경영관 쪽문 앞", 5, "평지", "도보");
//105
...
//3층 입구
 ...
 graph.addEdge("학림관 좌측 앞문", "학림관", 100000, "평지", "도보");
  ...
  //**************************************************************************
  //사회과학관_경영관(입구: 입구, 쪽문, 엘베 입구, 경영관 2층 뒷문)
  //424
  graph.addEdge("사회과학관 입구", "사회과학관_경영관", 100, "평지", "도보",
      node2X: 2295,
      node2Y: 3098,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("사회과학관_경영관", "사회과학관 입구", 100, "평지", "도보");
  ...
  graph.addEdge("사회과학관_경영관", "사회과학관 입구", 100, "평지", "도보");
  //사회과학관 쪽문
  graph.addEdge("사회과학관 쪽문", "사회과학관_경영관", 100, "평지", "도보");
  graph.addEdge("사회과학관_경영관", "사회과학관 쪽문", 100, "평지", "도보");
  //사회과학관 엘베 입구
  graph.addEdge("사회과학관 엘베 입구", "사회과학관_경영관", 100, "평지", "도보");
  graph.addEdge("사회과학관_경영관", "사회과학관 엘베 입구", 100, "평지", "도보");
  //경영관 2층 뒷문
  graph.addEdge("경영관 2층 뒷문", "사회과학관_경영관", 100, "평지", "도보");
  graph.addEdge("사회과학관_경영관", "경영관 2층 뒷문", 100, "평지", "도보");
...
//      경영관
//경영관 쪽문
  graph.addEdge("경영관 쪽문", "사회과학관_경영관", 100, "평지", "도보");
  graph.addEdge("사회과학관_경영관", "경영관 쪽문", 100, "평지", "도보");
//사회과학관 옆문
  graph.addEdge("사회과학관 옆문", "사회과학관_경영관", 100, "평지", "도보");
  graph.addEdge("사회과학관_경영관", "사회과학관 옆문", 100, "평지", "도보");
//경영관 입구
  graph.addEdge("경영관 입구", "사회과학관_경영관", 100, "평지", "도보");
  graph.addEdge("사회과학관_경영관", "경영관 입구", 100, "평지", "도보");
//      문화관
//문화관 쪽문
