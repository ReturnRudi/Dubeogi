...
//213
  graph.addEdge("팔정도 후문 차도1", "팔정도 후문 차도2", 5.42306, 0.361537, "내리막", "차도",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("팔정도 후문 차도2", "팔정도 후문 차도1", 5.42306, 0.361537, "오르막", "차도");
//214
  graph.addEdge("팔정도 후문 차도2", "헐떡고개 위", 4.87303, 0.324869, "내리막", "차도",
      ...
      building2: "실외",
      showRoute2: true);
  graph.addEdge("헐떡고개 위", "팔정도 후문 차도2", 4.87303, 0.324869, "오르막", "차도");
//215
  graph.addEdge("헐떡고개 위", "만해광장 입구", 16.9273, 1.12849, "내리막", "차도",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("만해광장 입구", "헐떡고개 위", 16.9273, 1.12849, "오르막", "차도");
//216
  graph.addEdge("만해광장 입구", "팔정도 후문 차도3", 14.3917, 0.959448, "내리막", "차도",
      ...
      building2: "실외",
      showRoute2: true);
  graph.addEdge("팔정도 후문 차도3", "만해광장 입구", 14.3917, 0.959448, "오르막", "차도");
//217
...
//218
  graph.addEdge("지하주차장 가는길1", "지하주차장 가는길2", 14.462, 0.964132, "평지", "차도",
      node2X: 1078,
      node2Y: 2382,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("지하주차장 가는길2", "지하주차장 가는길1", 14.462, 0.964132, "평지", "차도");
//219
...
//220
  graph.addEdge("팔정도 본관 계단 아래", "팔정도 본관 계단 중간", 12.1991, 0.813272, "계단위", "도보",
      node2X: 1255,
      node2Y: 2414,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("팔정도 본관 계단 중간", "팔정도 본관 계단 아래", 12.1991, 0.813272, "계단아래", "도보");
//221
  graph.addEdge("팔정도 본관 계단 중간", "팔정도 본관 계단 위", 11.7709, 0.784724, "계단위", "도보");
  graph.addEdge("팔정도 본관 계단 위", "팔정도 본관 계단 중간", 11.7709, 0.784724, "계단아래", "도보");
//222 본관 1층인지 불확실
...
//228
  graph.addEdge("헐떡고개 위", "헐떡고개 아래", 40.3351, 2.68901, "내리막", "도보",
      node2X: 1282,
      node2Y: 2029,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("헐떡고개 아래", "헐떡고개 위", 40.3351, 2.68901, "오르막", "도보");
//229
  graph.addEdge("헐떡고개 아래", "체육관 옆문 앞", 5.48794, 0.365862, "내리막", "도보",
      ...
      building2: "실외",
      showRoute2: false);
  graph.addEdge("체육관 옆문 앞", "헐떡고개 아래", 5.48794, 0.365862, "오르막", "도보");
//230
...
//231
  graph.addEdge("체육관 옆문 앞", "듀이카 가는길1", 28.64, 1.90933, "내리막", "차도",
      node2X: 1322,
      node2Y: 1843,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("듀이카 가는길1", "체육관 옆문 앞", 28.64, 1.90933, "오르막", "차도");
//232
...
//240
  graph.addEdge("듀이카 앞 계단 위", "듀이카 앞 계단 중간1", 4.89609, 0.326406, "계단아래", "도보",
      node2X: 1541,
      node2Y: 1886,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("듀이카 앞 계단 중간1", "듀이카 앞 계단 위", 4.89609, 0.326406, "계단위", "도보");
//241
...
//242
  graph.addEdge("듀이카 앞 계단 중간1", "듀이카 앞 계단 중간2", 3.4082, 0.227213, "계단아래", "도보",
      node2X: 1541,
      node2Y: 1905,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("듀이카 앞 계단 중간2", "듀이카 앞 계단 중간1", 3.4082, 0.227213, "계단위", "도보");
//243
  graph.addEdge("듀이카 앞 계단 중간2", "듀이카 앞 계단 중간3", 7.83128, 0.522085, "계단아래", "도보",
      node2X: 1582,
      node2Y: 1920,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("듀이카 앞 계단 중간3", "듀이카 앞 계단 중간2", 7.83128, 0.522085, "계단위", "도보");
//346
  graph.addEdge("듀이카 앞 계단 중간3", "듀이카쪽 학교 입구", 8.22995, 0.548663, "계단아래", "도보",
      node2X: 1625,
      node2Y: 1936,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("듀이카쪽 학교 입구", "듀이카 앞 계단 중간3", 8.22995, 0.548663, "계단위", "도보");
//345
...
//245
  graph.addEdge("학림관 뒷길1", "반야관 편의점 가는길1", 11.3591, 0.757272, "계단아래", "도보",
      node2X: 1541,
      node2Y: 1731,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("반야관 편의점 가는길1", "학림관 뒷길1", 11.3591, 0.757272, "계단위", "도보");
//246
  graph.addEdge("반야관 편의점 가는길1", "반야관 편의점 가는길2", 13.2023, 0.880155, "계단아래", "도보",
      node2X: 1600,
      node2Y: 1775,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("반야관 편의점 가는길2", "반야관 편의점 가는길1", 13.2023, 0.880155, "계단위", "도보");
//247
  graph.addEdge("반야관 편의점 가는길2", "반야관 편의점 입구", 9.47827, 0.631884, "계단아래", "도보",
      node2X: 1626,
      node2Y: 1821,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("반야관 편의점 입구", "반야관 편의점 가는길2", 9.47827, 0.631884, "계단위", "도보");
//248
...
//251
  graph.addEdge("학림관 뒷길3", "학림관 뒷길4", 16.5816, 1.10544, "계단아래", "도보",
      node2X: 1282,
      node2Y: 1705,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("학림관 뒷길4", "학림관 뒷길3", 16.5816, 1.10544, "계단위", "도보");
//252
  graph.addEdge("학림관 뒷길4", "학림관 뒷문", 3.5741, 0.238273, "계단위", "도보",
      node2X: 1276,
      node2Y: 1724,
      isInside2: 0,
      building2: "실외",
      showRoute2: true);
  graph.addEdge("학림관 뒷문", "학림관 뒷길4", 3.5741, 0.238273, "계단아래", "도보");
//253
  graph.addEdge("학림관 뒷길4", "학림관 뒷길5", 13.8168, 0.921122, "계단위", "도보",
      node2X: 1215,
      node2Y: 1667,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("학림관 뒷길5", "학림관 뒷길4", 13.8168, 0.921122, "계단아래", "도보");
//254
  graph.addEdge("학림관 뒷길5", "학림관 왼쪽 뒷문", 10.3807, 0.69205, "계단위", "도보",
      node2X: 1197,
      node2Y: 1722,
      isInside2: 0,
      building2: "실외",
      showRoute2: true);
  graph.addEdge("학림관 왼쪽 뒷문", "학림관 뒷길5", 10.3807, 0.69205, "계단아래", "도보");
//255
  graph.addEdge("학림관 뒷길5", "후문", 24.3863, 1.62575, "내리막", "도보",
      ...
      building2: "실외",
      showRoute2: true);
  graph.addEdge("후문", "학림관 뒷길5", 24.3863, 1.62575, "오르막", "도보");
//256
  graph.addEdge("후문", "후문 학생회관1", 22.451, 1.49674, "오르막", "도보",
      node2X: 993,
      node2Y: 1608,
      isInside2: 0,
      building2: "실외",
...
//258
  graph.addEdge("후문 학생회관2", "후문 학생회관3", 17.612, 1.17414, "평지", "도보",
      node2X: 882,
      node2Y: 1725,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("후문 학생회관3", "후문 학생회관2", 17.612, 1.17414, "평지", "도보");
//259
  graph.addEdge("후문 학생회관3", "학생회관 학림관 계단 아래", 11.8905, 0.792702, "평지", "도보",
      node2X: 869,
      node2Y: 1790,
      isInside2: 0,
      building2: "실외",
      showRoute2: true);
  graph.addEdge("학생회관 학림관 계단 아래", "후문 학생회관3", 11.8905, 0.792702, "평지", "도보");
//260
  graph.addEdge("학생회관 학림관 계단 아래", "학생회관 계단 입구", 8.21625, 0.54775, "계단위", "도보",
      node2X: 832,
      node2Y: 1817,
      isInside2: 0,
      building2: "실외",
      showRoute2: true);
  graph.addEdge("학생회관 계단 입구", "학생회관 학림관 계단 아래", 8.21625, 0.54775, "계단아래", "도보");
//261
  graph.addEdge("학생회관 학림관 계단 아래", "학생회관 학림관 계단 중간", 8.09394, 0.539596, "계단위", "도보",
      node2X: 913,
      node2Y: 1780,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("학생회관 학림관 계단 중간", "학생회관 학림관 계단 아래", 8.09394, 0.539596, "계단아래", "도보");
//262
  graph.addEdge("학생회관 학림관 계단 중간", "학생회관 학림관 계단 위", 6.8376, 0.45584, "계단위", "도보",
      node2X: 951,
      node2Y: 1783,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("학생회관 학림관 계단 위", "학생회관 학림관 계단 중간", 6.8376, 0.45584, "계단아래", "도보");
//263
  graph.addEdge("학생회관 학림관 계단 아래", "학생회관 옆 계단 위", 7.84564, 0.523043, "계단위", "도보",
      node2X: 861,
      node2Y: 1833,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("학생회관 옆 계단 위", "학생회관 학림관 계단 아래", 7.84564, 0.523043, "계단아래", "도보");
//264
...
//271
  graph.addEdge("계산관A 계단 위", "계산관A 계단 아래", 4.14128, 0.276085, "계단아래", "도보",
      node2X: 1044,
      node2Y: 1740,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("계산관A 계단 아래", "계산관A 계단 위", 4.14128, 0.276085, "계단위", "도보");
//272
...
//273
  graph.addEdge("계산관A 학림관 갈림길", "학림관 편의점 입구", 6.97735, 0.465157, "계단아래", "도보",
      node2X: 1090,
      node2Y: 1721,
      isInside2: 0,
      building2: "실외",
      showRoute2: true);
  graph.addEdge("학림관 편의점 입구", "계산관A 학림관 갈림길", 6.97735, 0.465157, "계단위", "도보");
//274
...
//285
  graph.addEdge("팔정도 후문 차도5", "팔정도 후문 차도6", 6.83054, 0.455369, "평지", "차도");
  graph.addEdge("팔정도 후문 차도6", "팔정도 후문 차도5", 6.83054, 0.455369, "평지", "차도");
//286
  graph.addEdge("팔정도 후문 차도5", "만해광장 계단 아래", 18.316, 1.22106, "오르막", "차도",
      node2X: 913,
      node2Y: 2027,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("만해광장 계단 아래", "팔정도 후문 차도5", 18.316, 1.22106, "내리막", "차도");
//287
  graph.addEdge("만해광장 계단 아래", "만해광장 계단 위", 15.5523, 1.03682, "오르막", "도보",
      node2X: 999,
      node2Y: 2038,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("만해광장 계단 위", "만해광장 계단 아래", 15.5523, 1.03682, "내리막", "도보");
//288
  graph.addEdge("만해광장 계단 위", "만해광장", 18.4446, 1.22964, "평지", "도보",
      node2X: 1101,
      node2Y: 2051,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("만해광장", "만해광장 계단 위", 18.4446, 1.22964, "평지", "도보");
//289
  graph.addEdge("만해광장", "만해광장 입구", 38.7799, 2.58532, "평지", "도보");
  graph.addEdge("만해광장 입구", "만해광장", 38.7799, 2.58532, "평지", "도보");
//290
...
//291
  graph.addEdge("팔정도 후문 차도4", "팔정도 후문 차도3", 43.8804, 2.92536, "오르막", "차도");
  graph.addEdge("팔정도 후문 차도3", "팔정도 후문 차도4", 43.8804, 2.92536, "내리막", "차도");
//292
...
//293
  graph.addEdge("원흥관 앞 계단 아래", "원흥관 앞 계단 중간1", 11.8036, 0.786908, "계단위", "도보",
      node2X: 943,
      node2Y: 2161,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("원흥관 앞 계단 중간1", "원흥관 앞 계단 아래", 11.8036, 0.786908, "계단아래", "도보");
//294
  graph.addEdge("원흥관 앞 계단 중간1", "원흥관 앞 계단 중간2", 30.9718, 2.06479, "계단위", "도보",
      node2X: 1017,
      node2Y: 2317,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("원흥관 앞 계단 중간2", "원흥관 앞 계단 중간1", 30.9718, 2.06479, "계단아래", "도보");
//295
  graph.addEdge("원흥관 앞 계단 중간2", "원흥관 앞 계단 위", 3.60547, 0.240365, "계단위", "도보",
      node2X: 1037,
      node2Y: 2319,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("원흥관 앞 계단 위", "원흥관 앞 계단 중간2", 3.60547, 0.240365, "계단아래", "도보");
//296
...
//305
  graph.addEdge("정P 뒷길 계단 위", "정P 뒷길 계단 아래", 5.10206, 0.340137, "계단아래", "도보",
      node2X: 780,
      node2Y: 2083,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("정P 뒷길 계단 아래", "정P 뒷길 계단 위", 5.10206, 0.340137, "계단위", "도보");
//306
  graph.addEdge("정P 뒷길 계단 아래", "자취촌 학교 입구", 16.1092, 1.07395, "계단아래", "도보",
      node2X: 691,
      node2Y: 2095,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("자취촌 학교 입구", "정P 뒷길 계단 아래", 16.1092, 1.07395, "계단위", "도보");
//307
...
//308
  graph.addEdge("정P 뒷길2", "정P 뒷길3", 6.63702, 0.442468, "계단아래", "도보",
      node2X: 774,
      node2Y: 1974,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("정P 뒷길3", "정P 뒷길2", 6.63702, 0.442468, "계단위", "도보");
//309
...
//315
  graph.addEdge("원흥관 신공학관1", "원흥관 신공학관2", 17.5333, 1.16889, "계단위", "도보",
      node2X: 908,
      node2Y: 2436,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("원흥관 신공학관2", "원흥관 신공학관1", 17.5333, 1.16889, "계단아래", "도보");
//316
...
//324
  ...
  //583
  graph.addEdge("108계단 위", "원흥관 3층 야외 계단 앞", 2.43982, 0.162654, "계단아래", "도보",
      node2X: 962,
      node2Y: 2588,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("원흥관 3층 야외 계단 앞", "108계단 위", 2.43982, 0.162654, "계단위", "도보");
  //584
  graph.addEdge("원흥관 3층 야외 계단 앞", "원흥관 3층 야외 계단", 2.49201, 0.166134, "계단아래", "도보",
      node2X: 950,
      node2Y: 2581,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("원흥관 3층 야외 계단", "원흥관 3층 야외 계단 앞", 2.49201, 0.166134, "계단위", "도보");
  //585
  graph.addEdge("108계단 위", "108계단 중간2", 5.22359, 0.348239, "계단아래", "도보");
  graph.addEdge("108계단 중간2", "108계단 위", 5.22359, 0.348239, "계단위", "도보");
//325
...
//327
  graph.addEdge("108계단 중간1", "원흥별관 쪽문 앞", 7.20424, 0.480283, "계단아래", "도보",
      node2X: 825,
      node2Y: 2558,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("원흥별관 쪽문 앞", "108계단 중간1", 7.20424, 0.480283, "계단위", "도보");
//328
...
//329
  graph.addEdge("원흥별관 쪽문 앞", "108계단 아래", 12.3094, 0.820624, "계단아래", "도보",
      node2X: 760,
      node2Y: 2536,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("108계단 아래", "원흥별관 쪽문 앞", 12.3094, 0.820624, "계단위", "도보");
//330
...
//332
  graph.addEdge("신공 3층 입구 앞", "신공 오르막", 21.137, 1.40914, "내리막", "도보",
      node2X: 636,
      node2Y: 2538,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("신공 오르막", "신공 3층 입구 앞", 21.137, 1.40914, "오르막", "도보");
//333
  graph.addEdge("신공 오르막", "충무로쪽 입구", 11.4015, 0.7601, "내리막", "도보",
      ...
      building2: "실외",
      showRoute2: true);
  graph.addEdge("충무로쪽 입구", "신공 오르막", 11.4015, 0.7601, "오르막", "도보");
  //334
...
//335
  graph.addEdge("남산학사 계단 위", "남산학사 계단 아래", 3.52423, 0.234949, "계단아래", "도보",
      node2X: 598,
      node2Y: 2595,
      isInside2: 1,
      building2: "신공학관",
      showRoute2: false);
  graph.addEdge("남산학사 계단 아래", "남산학사 계단 위", 3.52423, 0.234949, "계단위", "도보");
//336
...
//3층 입구
  ...
  //415
  graph.addEdge("학림관 B1 엘베 앞", "학림관 왼쪽 뒷문 안", 3.06523, 0.204348, "계단아래", "도보",
      node2X: 1195,
      node2Y: 1729,
      isInside2: -1,
      building2: "학림관",
      showRoute2: false);
  graph.addEdge("학림관 왼쪽 뒷문 안", "학림관 B1 엘베 앞", 3.06523, 0.204348, "계단위", "도보");
  //416
  ...
  //427
  graph.addEdge("혜화관 4층 계단", "혜화관 4층 계단 중간1", 4.36816, 0.291211, "계단아래", "도보",
      node2X: 1954,
      node2Y: 2928,
      isInside2: 4,
      building2: "혜화관",
      showRoute2: false);
  graph.addEdge("혜화관 4층 계단 중간1", "혜화관 4층 계단", 4.36816, 0.291211, "계단위", "도보");
  //428
  ...
  //429
  graph.addEdge("혜화관 4층 계단 중간2", "혜화관 3층 계단", 4.19915, 0.279943, "계단아래", "도보",
      node2X: 1981,
      node2Y: 2922,
      isInside2: 4,
      building2: "혜화관",
      showRoute2: false);
  graph.addEdge("혜화관 3층 계단", "혜화관 4층 계단 중간2", 4.19915, 0.279943, "계단위", "도보");
  //혜화관 계단 1층 - 3층 이동
  ...
  //경영관 문화관 구름다리 이동
  graph.addEdge("경영관 문화관 구름다리 입구", "문화관 경영관 구름다리 입구", 2.43982, 0.162654, "계단아래", "도보",
      node2X: 2354,
      node2Y: 3065,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("문화관 경영관 구름다리 입구", "경영관 문화관 구름다리 입구", 2.43982, 0.162654, "계단위", "도보");
  //446
...
//명진관 우측 입구
  ...
  //568
  graph.addEdge("원흥관 3층 야외 계단문", "원흥관 3층 야외 계단", 1.80273, 0.120182, "계단위", "도보",
      node2X: 950,
      node2Y: 2581,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("원흥관 3층 야외 계단", "원흥관 3층 야외 계단문", 1.80273, 0.120182, "계단아래", "도보");
  //원흥관 야외 계단 3층 - 4층 이동
  ...
  //582
  graph.addEdge("원흥관 4층 야외 계단문", "원흥관 4층 야외 계단", 1.80273, 0.120182, "계단위", "도보",
      node2X: 950,
      node2Y: 2581,
      isInside2: 0,
      building2: "실외",
      showRoute2: false);
  graph.addEdge("원흥관 4층 야외 계단", "원흥관 4층 야외 계단문", 1.80273, 0.120182, "계단아래", "도보");
  //원흥관 3층 후문
  ...
  //642
  graph.addEdge("다향관 1층 오른쪽 계단 앞", "다향관 1층 오른쪽 계단", 3.2338, 0.215587, "계단위", "도보",
      node2X: 1566,
      node2Y: 2523,
      isInside2: 1,
      building2: "다향관",
      showRoute2: false);
  graph.addEdge("다향관 1층 오른쪽 계단", "다향관 1층 오른쪽 계단 앞", 3.2338, 0.215587, "계단아래", "도보");
  //다향관 오른쪽 계단 1층 - 2층 이동
  ...
  //644
  graph.addEdge("다향관 2층 오른쪽 계단", "다향관 2층 세미나실 오른쪽", 3.69799, 0.246533, "계단위", "도보",
      node2X: 1548,
      node2Y: 2509,
      isInside2: 2,
      building2: "다향관",
      showRoute2: false);
  graph.addEdge("다향관 2층 세미나실 오른쪽", "다향관 2층 오른쪽 계단", 3.69799, 0.246533, "계단아래", "도보");
  //645
  ...
  //646
  graph.addEdge("다향관 2층 세미나실 왼쪽", "다향관 3층 오른쪽 계단", 3.00694, 0.200462, "계단위", "도보",
      node2X: 1561,
      node2Y: 2522,
      isInside2: 2,
      building2: "다향관",
      showRoute2: false);
  graph.addEdge("다향관 3층 오른쪽 계단", "다향관 2층 세미나실 왼쪽", 3.00694, 0.200462, "계단아래", "도보");
  //647
  graph.addEdge("다향관 3층 오른쪽 계단", "다향관 3층 오른쪽 계단 앞", 2.78471, 0.185647, "계단위", "도보",
      node2X: 1576,
      node2Y: 2526,
      isInside2: 3,
      building2: "다향관",
      showRoute2: false);
  graph.addEdge("다향관 3층 오른쪽 계단 앞", "다향관 3층 오른쪽 계단", 2.78471, 0.185647, "계단아래", "도보");
  //648
